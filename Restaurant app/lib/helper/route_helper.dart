import 'dart:convert';
import 'package:mnjood_vendor/common/screens/payment_screen.dart';
import 'package:mnjood_vendor/features/addon/screens/add_addon_screen.dart';
import 'package:mnjood_vendor/features/advertisement/screens/advertisement_details_screen.dart';
import 'package:mnjood_vendor/features/advertisement/screens/advertisement_list_screen.dart';
import 'package:mnjood_vendor/features/advertisement/screens/create_advertisement_screen.dart';
import 'package:mnjood_vendor/features/business/screens/subscription_payment_screen.dart';
import 'package:mnjood_vendor/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:mnjood_vendor/features/campaign/screens/campaign_details_screen.dart';
import 'package:mnjood_vendor/features/campaign/screens/campaign_screen.dart';
import 'package:mnjood_vendor/features/category/screens/category_screen.dart';
...
import 'package:mnjood_vendor/features/deliveryman/screens/add_delivery_man_screen.dart';
import 'package:mnjood_vendor/features/deliveryman/screens/delivery_man_details_screen.dart';
import 'package:mnjood_vendor/features/deliveryman/screens/delivery_man_screen.dart';
import 'package:mnjood_vendor/features/disbursement/screens/add_withdraw_method_screen.dart';
import 'package:mnjood_vendor/features/disbursement/screens/disbursement_menu_screen.dart';
import 'package:mnjood_vendor/features/disbursement/screens/disbursement_screen.dart';
import 'package:mnjood_vendor/features/disbursement/screens/withdraw_method_screen.dart';
import 'package:mnjood_vendor/features/inventory/screens/inventory_dashboard_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/finance_dashboard_screen.dart';
import 'package:mnjood_vendor/features/pos/screens/pos_screen.dart';
import 'package:mnjood_vendor/features/pos/screens/pos_checkout_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/suppliers/suppliers_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/suppliers/add_supplier_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/suppliers/supplier_details_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/purchase_orders/purchase_orders_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/purchase_orders/create_purchase_order_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/purchase_orders/purchase_order_details_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/invoices/invoices_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/invoices/invoice_details_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/expenses/expenses_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/expenses/add_expense_screen.dart';
import 'package:mnjood_vendor/features/finance/screens/reports/finance_reports_screen.dart';
import 'package:mnjood_vendor/features/expense/screens/expense_screen.dart';
import 'package:mnjood_vendor/features/auth/screens/forget_pass_screen.dart';
import 'package:mnjood_vendor/features/auth/screens/new_pass_screen.dart';
import 'package:mnjood_vendor/features/auth/screens/verification_screen.dart';
import 'package:mnjood_vendor/features/html/screens/html_viewer_screen.dart';
import 'package:mnjood_vendor/features/language/screens/language_screen.dart';
import 'package:mnjood_vendor/features/notification/screens/notification_screen.dart';
import 'package:mnjood_vendor/features/order/domain/models/order_model.dart';
import 'package:mnjood_vendor/features/order/screens/edit_delivery_address/edit_delivery_address_screen.dart';
import 'package:mnjood_vendor/features/order/screens/edit_delivery_address/pick_map_screen.dart';
import 'package:mnjood_vendor/features/order/screens/edit_order/add_new_product_screen.dart';
import 'package:mnjood_vendor/features/order/screens/edit_order/edit_product_screen.dart';
import 'package:mnjood_vendor/features/payment/screens/bank_info_screen.dart';
import 'package:mnjood_vendor/features/payment/screens/payment_history_screen.dart';
import 'package:mnjood_vendor/features/payment/screens/payment_successful_screen.dart';
import 'package:mnjood_vendor/features/payment/screens/wallet_screen.dart';
import 'package:mnjood_vendor/features/payment/screens/withdraw_request_history_screen.dart';
import 'package:mnjood_vendor/features/reports/screens/tax/screens/tax_report_screen.dart';
...
import 'package:mnjood_vendor/features/addon/screens/addon_screen.dart';
import 'package:mnjood_vendor/features/auth/screens/restaurant_registration_screen.dart';
import 'package:mnjood_vendor/features/auth/screens/sign_in_screen.dart';
import 'package:mnjood_vendor/features/chat/screens/chat_screen.dart';
import 'package:mnjood_vendor/features/chat/screens/conversation_screen.dart';
import 'package:mnjood_vendor/features/order_chat/screens/order_chat_screen.dart';
import 'package:mnjood_vendor/features/coupon/screens/coupon_screen.dart';
import 'package:mnjood_vendor/features/profile/screens/profile_screen.dart';
import 'package:mnjood_vendor/features/profile/screens/update_profile_screen.dart';
import 'package:mnjood_vendor/features/reports/screens/campaign/screens/campaign_report_screen.dart';
import 'package:mnjood_vendor/features/reports/screens/food/screens/food_report_screen.dart';
import 'package:mnjood_vendor/features/reports/screens/order/screens/order_report_screen.dart';
import 'package:mnjood_vendor/features/reports/screens/reports_screen.dart';
import 'package:mnjood_vendor/features/reports/screens/transaction/screens/transaction_report_screen.dart';
import 'package:mnjood_vendor/features/restaurant/domain/models/review_model.dart';
import 'package:mnjood_vendor/features/restaurant/screens/add_product_screen.dart';
import 'package:mnjood_vendor/features/restaurant/screens/all_product_screen.dart';
import 'package:mnjood_vendor/features/restaurant/screens/announcement_screen.dart';
...
import 'package:mnjood_vendor/features/restaurant/screens/restaurant_edit_screen.dart';
import 'package:mnjood_vendor/features/restaurant/screens/restaurant_settings_screen.dart';
import 'package:mnjood_vendor/features/review/screens/customer_review_screen.dart';
import 'package:mnjood_vendor/features/review/screens/review_reply_screen.dart';
import 'package:mnjood_vendor/features/splash/screens/splash_screen.dart';
import 'package:mnjood_vendor/features/subscription/screens/my_subscription_screen.dart';
import 'package:mnjood_vendor/features/update/screens/update_screen.dart';
...
class RouteHelper {
  ...
  static const String financePurchaseOrders = '/finance-purchase-orders';
  ...
  static String getInventoryRoute() => inventory;

  // Finance Management getters
  static String getFinanceDashboardRoute() => financeDashboard;
  static String getFinanceSuppliersRoute() => financeSuppliers;
  static String getAddSupplierRoute() => addSupplier;
  static String getSupplierDetailsRoute(int id) => '$supplierDetails?id=$id';
  static String getFinancePurchaseOrdersRoute() => financePurchaseOrders;
  static String getCreatePurchaseOrderRoute() => createPurchaseOrder;
  static String getPurchaseOrderDetailsRoute(int id) => '$purchaseOrderDetails?id=$id';
  static String getFinanceInvoicesRoute() => financeInvoices;
  static String getInvoiceDetailsRoute(int id) => '$invoiceDetails?id=$id';
  static String getFinanceExpensesRoute() => financeExpenses;
  static String getAddExpenseRoute() => addExpense;
  static String getFinanceReportsRoute() => financeReports;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: orderDetails, page: () {
      int orderId = int.tryParse(Get.parameters['id'] ?? '0') ?? 0;
      return Get.arguments ?? OrderDetailsScreen(
        orderModel: OrderModel(id: orderId), isRunningOrder: false,
        orderId: orderId,
    ...
    GetPage(name: inventory, page: () => const InventoryDashboardScreen()),

    // POS
    GetPage(name: pos, page: () => const PosScreen()),

    // Finance Management
    GetPage(name: financeDashboard, page: () => const FinanceDashboardScreen()),
    GetPage(name: financeSuppliers, page: () => const SuppliersScreen()),
    GetPage(name: addSupplier, page: () => const AddSupplierScreen()),
    GetPage(name: supplierDetails, page: () {
      int id = int.parse(Get.parameters['id'] ?? '0');
      return SupplierDetailsScreen(supplierId: id);
    }),
    GetPage(name: financePurchaseOrders, page: () => const PurchaseOrdersScreen()),
    GetPage(name: createPurchaseOrder, page: () => const CreatePurchaseOrderScreen()),
    GetPage(name: purchaseOrderDetails, page: () {
      int id = int.parse(Get.parameters['id'] ?? '0');
      return PurchaseOrderDetailsScreen(orderId: id);
    }),
    GetPage(name: financeInvoices, page: () => const InvoicesScreen()),
    GetPage(name: invoiceDetails, page: () {
      int id = int.parse(Get.parameters['id'] ?? '0');
      return InvoiceDetailsScreen(invoiceId: id);
    }),
    GetPage(name: financeExpenses, page: () => const ExpensesScreen()),
    GetPage(name: addExpense, page: () => const AddExpenseScreen()),
    GetPage(name: financeReports, page: () => const FinanceReportsScreen()),
    GetPage(name: orderChat, page: () => OrderChatScreen(
