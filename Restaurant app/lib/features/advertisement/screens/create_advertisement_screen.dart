...
import 'package:mnjood_vendor/features/advertisement/enums/ads_type.dart';
import 'package:mnjood_vendor/features/advertisement/models/ads_details_model.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/create_advertisement_video_view_shimmer.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/custom_check_box.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/dotted_video_border.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/preview_profile_promotion_widget.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/preview_video_dialog_widget.dart';
                      ...
                      child: Column(children: [
                        ...
                        InkWell(
                          ...
                          child: CustomTextFieldWidget(
                            ...
                            isEnabled : false,
                            hideEnableText: true,
                            suffixIcon: HeroiconsOutline.calendar,
                            validator: (value) {
                        ...
                        adsController.pickedVideoFile == null && adsController.networkVideoFile == null ? AspectRatio(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  child: Icon(HeroiconsOutline.xMark, color: Theme.of(context).colorScheme.error),
                                ),
                              ),
                            ),
                            ...
                            FloatingActionButton.small(
                              ...
                              child: Icon(
                                adsController.videoPlayerController!.value.isPlaying ? HeroiconsSolid.pause : HeroiconsSolid.play,
                              ),
                            )
                          ],
                          ...
                          child: Stack(children: [
                            ...
                            adsController.pickedProfileImage != null || adsController.networkProfileImage != null ? Positioned(
                              ...
                              child: IconButton(
                                ...
                                icon: const Icon(HeroiconsOutline.xCircle, color: Colors.red, size: 25),
                              ),
                            ) : const SizedBox(),
                          ]),
                        ),
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        Icon(HeroiconsOutline.eyeSlash, size: 14, color: Theme.of(context).cardColor),
