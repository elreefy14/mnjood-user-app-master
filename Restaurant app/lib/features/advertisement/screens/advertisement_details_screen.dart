...
import 'package:mnjood_vendor/features/advertisement/widgets/ads_item.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/confirmation_bottom_sheet.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/network_video_preview_widget.dart';
      ...
      builder: (advertisementController) {
        return Scaffold(
          ...
          body: Column(children: [
            Expanded(
              child: advertisementController.advertisementDetailsModel == null ? const Center(child: CircularProgressIndicator()) : GetBuilder<AdvertisementController>(builder: (advertisementController) {
                  ...
                  return SingleChildScrollView(
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text("title".tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
            ...
            advertisementController.advertisementDetailsModel != null ? Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).cardColor,
                boxShadow: [BoxShadow(color: Theme.of(context).hintColor.withValues(alpha: 0.2), blurRadius: 10)],
              ),
