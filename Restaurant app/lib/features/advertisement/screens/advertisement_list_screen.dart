...
import 'package:mnjood_vendor/features/advertisement/widgets/confirmation_bottom_sheet.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/empty_ads_view.dart';
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  color: status == 'approved' ? Colors.green.withValues(alpha: 0.2)
                                      ...
                                      : status == 'expired' ? Theme.of(context).hintColor.withValues(alpha: 0.2)
                                ...
                                child: Text(
                                  ...
                                  style: robotoRegular.copyWith(
                                    ...
                                    color: status == 'approved' ? Colors.green
                                        ...
                                        : status == 'expired' ? Theme.of(context).hintColor
                            ...
                            Text(advertisementList[index].addType!.tr.replaceAll('_', ' ').toTitleCase(), style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                          ]),
                          ...
                          PopupMenuButton<PopupMenuModel>(
                                    ...
                                    if(option.title == "edit_ads"){
                                      if(status == 'running'){
                                        showCustomBottomSheet(child: ConfirmationBottomSheet(
                                          image: Images.warning, title: "do_you_want_to_edit",
                                          description: "confirm_edit_ads_dialog_description", status: option.title,
                                      ...
                                      Get.bottomSheet(ConfirmationBottomSheet(
                                        ...
                                        yesButtonPressed: () async{
                                          if(adsController.noteFormKey.currentState!.validate()){
                                            await adsController.changeAdvertisementStatus(id: advertisementList[index].id!, status: 'paused').then((success) {
                                              if(success) {
                                                Get.back();
                            ...
                            child: Container(
                              ...
                              child: const Icon(HeroiconsOutline.ellipsisVertical),
                            ),
                          ),
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                            child: Icon(HeroiconsOutline.arrowRight, size: 16, color: Theme.of(context).cardColor),
                          ),
                        )
