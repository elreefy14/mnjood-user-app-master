...
import 'package:mnjood_vendor/features/advertisement/models/popup_menu_model.dart';
import 'package:mnjood_vendor/features/advertisement/widgets/ads_create_success_bottom_sheet.dart';
...
import 'package:mnjood_vendor/helper/image_size_checker.dart';
...
class AdvertisementController extends GetxController implements GetxService {
  ...
  List<PopupMenuModel> getPopupMenuList(String status , int active) {
    ...
    if(status == "pending"){
      return [
        PopupMenuModel(title: "view_ads", icon: HeroiconsOutline.eye),
        PopupMenuModel(title: "edit_ads", icon: HeroiconsOutline.pencilSquare),
        PopupMenuModel(title: "copy_ads", icon: HeroiconsOutline.arrowPath),
        PopupMenuModel(title: "delete_ads", icon: HeroiconsOutline.trash),
      ];
    } else if(isApproved){
      return [
        PopupMenuModel(title: "view_ads", icon: HeroiconsOutline.eye),
      ...
      return [
        PopupMenuModel(title: "view_ads", icon: HeroiconsOutline.eye),
        PopupMenuModel(title: "edit_ads", icon: HeroiconsOutline.pencilSquare),
        PopupMenuModel(title: "pause_ads", icon: HeroiconsOutline.pauseCircle),
        PopupMenuModel(title: "copy_ads", icon: HeroiconsOutline.arrowPath),
        PopupMenuModel(title: "delete_ads", icon: HeroiconsOutline.trash),
      ];
      ...
      return [
        PopupMenuModel(title: "view_ads", icon: HeroiconsOutline.eye),
        PopupMenuModel(title: "edit_and_resubmit_ads", icon: HeroiconsOutline.pencilSquare),
        PopupMenuModel(title: "copy_ads", icon: HeroiconsOutline.arrowPath),
        PopupMenuModel(title: "delete_ads", icon: HeroiconsOutline.trash),
      ];
      ...
      return [
        PopupMenuModel(title: "view_ads", icon: HeroiconsOutline.eye),
        PopupMenuModel(title: "edit_ads", icon: HeroiconsOutline.pencilSquare),
        PopupMenuModel(title: "resume_ads", icon: HeroiconsOutline.play),
        PopupMenuModel(title: "copy_ads", icon: HeroiconsOutline.arrowPath),
        PopupMenuModel(title: "delete_ads", icon: HeroiconsOutline.trash),
      ];
