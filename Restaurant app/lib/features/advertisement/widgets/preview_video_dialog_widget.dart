              ...
              child: Container(
                ...
                child:  Column(mainAxisSize:  MainAxisSize.min, children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    InkWell(
                      onTap: ()=> Get.back(),
                      child: Icon(HeroiconsOutline.xMark, color: Theme.of(context).hintColor, size: 20,),
                    ),
                  ]),
                        ...
                        Stack(
                          ...
                          children: [
                            ...
                            FloatingActionButton.small(
                              ...
                              child: Icon(
                                advertisementController.videoPlayerController!.value.isPlaying ? HeroiconsSolid.pause : HeroiconsSolid.play,
                                color: Theme.of(context).cardColor,
                              ),
                            )
                          ],
                          ...
                          child: AspectRatio(
                            ...
                            child: Container(
                              ...
                              child: const Center(child: Icon(HeroiconsSolid.playCircle, color: Colors.white,size: 45,),),
                            ),
                          ),
                        ),
