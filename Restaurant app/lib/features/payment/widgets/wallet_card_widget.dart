...
import 'package:mnjood_vendor/features/payment/widgets/payment_method_bottom_sheet_widget.dart';
import 'package:mnjood_vendor/features/splash/controllers/splash_controller.dart';
import 'package:mnjood_vendor/features/payment/widgets/withdraw_request_bottom_sheet_widget.dart';
    ...
    return (profileController.profileModel!.adjustable! && (((profileController.profileModel!.balance! > 0) && (profileController.profileModel!.balance! > profileController.profileModel!.cashInHands!)
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          PriceConverter.convertPriceWithSvg(profileController.profileModel!.dynamicBalance!, textStyle: robotoBold.copyWith(fontSize: 24, color: Theme.of(context).cardColor),
          ),
