            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Icon(HeroiconsOutline.xMark, color: Theme.of(context).hintColor.withValues(alpha: 0.6), size: 22),
                ),
              ),
            ]),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          ...
                          child: DottedBorder(
                            ...
                            child: Center(
                              child: Visibility(
                                visible: restController.pickedLogo != null ? true : false,
                                child: Container(
                ...
                CustomButtonWidget(
                  ...
                  color: Colors.blue,
                  onPressed: () {
                    if(restController.pickedLogo == null) {
                      showCustomSnackBar('please_upload_an_image'.tr);
                    }else {
                      restController.generateAndSetDataFromImage(
                        ...
                        metaTitleController: widget.metaTitleController,
                        metaDescriptionController: widget.metaDescriptionController,
                        maxSnippetController: widget.maxSnippetController,
                        maxVideoPreviewController: widget.maxVideoPreviewController,
                      );
                    }
                  },
