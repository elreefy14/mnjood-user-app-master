                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          itemBuilder: (context, index){
                            return Container(
                              ...
                              child: Center(child: Row(children: [
                                ...
                                InkWell(onTap: () => aiController.removeKeyWord(index), child: Icon(HeroiconsOutline.xMark, size: 18, color: Theme.of(context).hintColor)),
                  ...
                  !aiController.isLoading ? SizedBox() : Shimmer(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(HeroiconsOutline.sparkles, color: Colors.blue),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                          ...
                          trailing: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                Icon(HeroiconsOutline.checkCircle, color: Colors.blue, size: 16),
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                Text('use'.tr, style: robotoRegular.copyWith(color: Colors.blue, fontSize: Dimensions.fontSizeSmall)),
