        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Row(children: [
                ...
                onTap: () {
                  ...
                  if(campaignModel.vendorStatus == null){
                    Get.dialog(ConfirmationDialogWidget(
                      icon: HeroiconsOutline.exclamationTriangle, description: campaignModel.isJoined! ? 'are_you_sure_to_leave'.tr : 'are_you_sure_to_join'.tr,
                      adminText: '' ,
                      onYesPressed: () {
              ...
              Icon(HeroiconsOutline.calendar, size: 15, color: Theme.of(context).hintColor),
