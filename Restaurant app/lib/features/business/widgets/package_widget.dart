    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
          Icon(HeroiconsSolid.checkCircle, size: 18, color: isSelect ? Theme.of(context).cardColor : Colors.green),
      ...
      Divider(indent: 20, endIndent: 50, color: isSelect ? Theme.of(context).cardColor.withValues(alpha: 0.2) : Theme.of(context).hintColor.withValues(alpha: 0.3), thickness: 1),
