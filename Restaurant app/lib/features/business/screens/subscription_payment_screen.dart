...
import 'package:mnjood_vendor/features/business/widgets/payment_cart_widget.dart';
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                LinearProgressIndicator(
                  backgroundColor: Theme.of(context).hintColor, minHeight: 2,
                  value: 0.75,
                ),
              ]),
            ),
                          ...
                          return InkWell(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).hintColor.withValues(alpha: 0.2), width: 1),
                              ),
