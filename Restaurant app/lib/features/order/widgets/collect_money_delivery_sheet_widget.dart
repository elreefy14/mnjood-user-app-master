          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            cod ? Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                PriceConverter.convertPriceWithSvg(orderAmount, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor), symbolSize: 14),
