                ...
                return Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Row(children: [
                      ...
                      Icon(orderController.orderCancelReasons![index].reason == orderController.cancelReason ? HeroiconsSolid.stop : HeroiconsOutline.stop, color: Theme.of(context).primaryColor, size: 18),
            ...
            Padding(
              ...
              child: !orderController.isLoading ? Row(children: [
                ...
                Expanded(child: CustomButtonWidget(
                  buttonText: 'cancel'.tr, color: Theme.of(context).hintColor, radius: 50,
                  onPressed: () => Get.back(),
                )),
