...
import 'package:mnjood_vendor/common/widgets/custom_time_picker_widget.dart';
                ...
                onTap: () => Get.dialog(Dialog(
                  ...
                  child: Padding(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      GetBuilder<RestaurantController>(builder: (providerController) {
                        return providerController.scheduleLoading ? const Center(child: CircularProgressIndicator()) : Row(children: [

                          Expanded(child: TextButton(
                            onPressed: () => Get.back(),
                            style: TextButton.styleFrom(
                              backgroundColor: Theme.of(context).hintColor.withValues(alpha: 0.3), minimumSize: const Size(1170, 40), padding: EdgeInsets.zero,
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      onTap: () => Get.dialog(ConfirmationDialogWidget(
                        icon: HeroiconsOutline.exclamationTriangle, description: 'are_you_sure_to_delete_this_schedule'.tr,
                        onYesPressed: () => Get.find<RestaurantController>().deleteSchedule(scheduleList[index].id),
                      ), barrierDismissible: false),
                      child: const Icon(HeroiconsOutline.xCircle, color: Colors.red),
                    ),
                  ),
                ),
