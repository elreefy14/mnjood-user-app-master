...
import 'package:mnjood_vendor/features/chat/widgets/conversation_details_shimmer_widget.dart';
...
import 'package:mnjood_vendor/features/chat/widgets/message_bubble_widget.dart';
                        ...
                        productView: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return MessageBubbleWidget(
                              ...
                              userType: widget.notificationBody!.adminId != null ? UserType.admin : UserType.delivery_man,
                            );
                          },
                        ),
                      ),
                    ...
                    child: Column(children: [
                      ...
                      chatController.pickedVideoFile != null ? Container(
                        ...
                        child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                          ...
                          const Icon(HeroiconsOutline.videoCameraSlash, size: 30),
                              ...
                              child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                ...
                                MenuAnchor(
                                  ...
                                  menuChildren: List<MenuItemButton>.generate(2, (int index) => MenuItemButton(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(index == 0 ? HeroiconsOutline.documentDuplicate : HeroiconsOutline.videoCamera, size: 18, color: Theme.of(context).primaryColor),
                                        const SizedBox(width: Dimensions.paddingSizeSmall),
