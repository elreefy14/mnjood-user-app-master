      ...
      return AnimatedContainer(
        ...
        child: Row(children: [
          ...
          CustomInkWellWidget(
            ...
            child: Icon(businessController.freeTrialExpand ? HeroiconsOutline.chevronRight : HeroiconsOutline.chevronLeft, color: Theme.of(context).cardColor,),
          ),
          // const SizedBox(width: Dimensions.fontSizeExtraSmall),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  const Icon(HeroiconsOutline.arrowRight, color: Colors.green,),
                ]),
              ),
            ),
          ) : const SizedBox(),
