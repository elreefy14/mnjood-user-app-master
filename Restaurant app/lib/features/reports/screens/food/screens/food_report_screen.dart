...
import 'package:mnjood_vendor/features/reports/screens/food/widget/food_report_details_card_widget.dart';
import 'package:mnjood_vendor/features/reports/screens/food/widget/line_chart_widget.dart';
    ...
    return GetBuilder<ReportController>(builder: (reportController) {
      return Scaffold(
        ...
        appBar: CustomAppBarWidget(
          title: BusinessTypeHelper.getItemReportLabel(),
          menuWidget: Padding(
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(HeroiconsOutline.calendar, color: reportController.from != null && reportController.to != null ? Theme.of(context).cardColor : Theme.of(context).hintColor, size: 20),
                  ),
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    ...
                    PriceConverter.convertPriceWithSvg(reportController.earningAvg!, textStyle: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
