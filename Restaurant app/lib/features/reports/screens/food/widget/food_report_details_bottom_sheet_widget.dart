...
import 'package:mnjood_vendor/features/reports/widgets/title_with_amount_widget.dart';
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('item_details'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.6))),
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      Icon(HeroiconsSolid.star, color: Theme.of(context).primaryColor, size: 18),
