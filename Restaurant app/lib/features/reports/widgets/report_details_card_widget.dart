...
import 'package:mnjood_vendor/features/reports/screens/order/widget/order_transaction_details_bottom_sheet_widget.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(children: [
          ...
          Divider(height: 2, color: Theme.of(context).hintColor.withValues(alpha: 0.6)),
            ...
            child: Padding(
              ...
              child: Row(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('order_amount'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                  PriceConverter.convertPriceWithSvg(orders.orderAmount, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Colors.blue)),
