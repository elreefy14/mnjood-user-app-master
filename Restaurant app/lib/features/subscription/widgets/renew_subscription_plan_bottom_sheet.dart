...
import 'package:mnjood_vendor/features/business/widgets/curve_clipper_widget.dart';
...
import 'package:mnjood_vendor/features/subscription/domain/models/check_product_limit_model.dart';
                      ...
                      child: Stack(children: [
                        ...
                        Positioned(
                          ...
                          child: Column(children: [
                            ...
                            Divider(color: Theme.of(context).hintColor.withValues(alpha: 0.2), indent: 40, endIndent: 40, thickness: 1),
                            ...
                            businessIsCommission ? const SizedBox() : Text('${activePackage?.validity} ' 'days'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
                    ...
                    isRenew ? Stack(children: [
                      ...
                      Positioned(
                        ...
                        child: Column(children: [
                          ...
                          PriceConverter.convertPriceWithSvg(package.price, textStyle: robotoBold.copyWith(fontSize: 25, color: Theme.of(context).cardColor),
                          ),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('validity'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('price'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        PriceConverter.convertPriceWithSvg(price, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                      ]),
                    ),

                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('bill_status'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                      border: Border.all(color: subscriptionController.isSelect && subscriptionController.paymentIndex == 0 ? Theme.of(context).primaryColor : Theme.of(context).hintColor.withValues(alpha: 0.2)),
                    ),
                    child:  Row(children: [
                      Container(
                        height: 20, width: 20,
                        ...
                        child: Icon(HeroiconsOutline.check, color: Theme.of(context).cardColor, size: 16),
                      ),
                      ...
                      PriceConverter.convertPriceWithSvg(subscriptionController.profileModel!.balance, textStyle: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault),
                      ),
