            ...
            Column(children: [
              ...
              RichText(
                ...
                text: TextSpan(children: [
                  TextSpan(text: 'thank_you_for_transaction_with'.tr, style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                  TextSpan(text: ' ${AppConstants.appName} ', style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
                  TextSpan(text: '${'in'.tr} ${transactions.package!.packageName} ${'package'.tr}', style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                ]),
              ),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  PriceConverter.convertPriceWithSvg(transactions.paidAmount, textStyle: robotoRegular),
                ]),
                const SizedBox(height: 40),
