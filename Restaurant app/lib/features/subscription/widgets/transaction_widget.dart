...
import 'package:mnjood_vendor/features/subscription/domain/models/subscription_transaction_model.dart';
import 'package:mnjood_vendor/features/subscription/widgets/transaction_details_bottom_sheet.dart';
    ...
    return GetBuilder<SubscriptionController>(builder: (subscriptionController) {
      return Column(children: [
          ...
          child: Row(children: [
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(width: 1, color: Theme.of(context).hintColor.withValues(alpha: 0.4)),
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(subscriptionController.searchMode ? HeroiconsOutline.xMark : HeroiconsOutline.magnifyingGlass, color: Theme.of(context).hintColor),
                    onPressed: (){
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Icon(HeroiconsOutline.calendar, color: Theme.of(context).hintColor, size: 20),
              ),
            ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text('from'.tr, style: robotoMedium.copyWith(color: Theme.of(context).hintColor)),
          ...
          Text('to'.tr, style: robotoMedium.copyWith(color: Theme.of(context).hintColor)),
          const SizedBox(width: 5),
                      ...
                      child: Column(children: [
                        ...
                        Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(DateConverter.utcToDateTime(transactions.createdAt!), style: robotoRegular.copyWith(color: Theme.of(context).hintColor)),
                            const SizedBox(width: Dimensions.paddingSizeDefault),

                            Flexible(child: Text(transactions.package?.packageName ?? '', style: robotoRegular.copyWith(color: Theme.of(context).hintColor), overflow: TextOverflow.ellipsis, maxLines: 1)),
                        ...
                        Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeDefault, bottom: Dimensions.paddingSizeDefault),
                          child: Row(children: [
                            ...
                            PriceConverter.convertPriceWithSvg(transactions.paidAmount, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
