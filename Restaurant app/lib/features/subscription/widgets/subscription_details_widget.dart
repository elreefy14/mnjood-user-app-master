...
import 'package:mnjood_vendor/features/subscription/widgets/billing_info_widget.dart';
import 'package:mnjood_vendor/features/subscription/widgets/change_subscription_plan_bottom_sheet.dart';
import 'package:mnjood_vendor/features/subscription/widgets/subscription_dialog_widget.dart';
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                && widget.subscriptionController.profileModel!.id != null /*&& Get.find<SplashController>().configModel!.businessPlan!.subscription != 0*/) ? JustTheTooltip(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        InkWell(
                          ...
                          child: const Icon(HeroiconsOutline.xMark, size: 22, color: Colors.white),
                        ),
                  ...
                  child: InkWell(
                    ...
                    child: const Icon(HeroiconsOutline.informationCircle, size: 22, color: Color(0xffFF6D6D)),
                  ),
                ) : const SizedBox(),
        ...
        child: Column(children: [
          ...
          !businessIsCommission && widget.subscriptionController.profileModel!.subscription!.isCanceled == 0 ? InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                border: Border.all(color: Theme.of(context).hintColor.withValues(alpha: 0.7)),
              ),
              child: Text('cancel_subscription'.tr, style: robotoMedium.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
            ),
          ) : const SizedBox(),
...
class PackageFeatureItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      const Icon(HeroiconsOutline.checkCircle, color: Colors.blue, size: 20),
      const SizedBox(width: Dimensions.paddingSizeDefault),
    
      Text(title, style: robotoRegular),
      const SizedBox(width: Dimensions.paddingSizeExtraSmall),

      leftValue != null ? Text('($leftValue)', style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
