...
import 'package:mnjood_vendor/features/support/widgets/custom_card_widget.dart';
import 'package:mnjood_vendor/features/support/widgets/element_widget.dart';
...
class _SupportScreenState extends State<SupportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('help_and_support'.tr, style: robotoMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeLarge)),
        centerTitle: true,
