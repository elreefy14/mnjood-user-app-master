...
import 'package:mnjood_vendor/features/auth/widgets/location_search_dialog_widget.dart';
import 'package:mnjood_vendor/features/auth/widgets/zone_selection_view_widget.dart';
      ...
      return SizedBox(child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Expanded(child: ZoneSelectionWidget(zoneList: zoneList)),
            ]),
    ...
    return locationController.zoneList!.isNotEmpty ? Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(clipBehavior: Clip.none, children: [
          ...
          Center(child: Image.asset(Images.pickMarker, height: 30, width: 20)),
          ...
          widget.fromView ? Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Icon(HeroiconsOutline.arrowsPointingOut, color: Theme.of(context).hintColor, size: 20),
              ),
            ),
          ) : const SizedBox(),
