...
import 'package:mnjood_vendor/features/expense/widgets/expense_card_widget.dart';
    ...
    return Scaffold(
      ...
      appBar: CustomAppBarWidget(
        ...
        menuWidget: CustomToolTip(
          ...
          child: Icon(HeroiconsOutline.informationCircle, size: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
        ),
      ),
                    ...
                    return TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          icon: Icon(expenseController.searchMode ? HeroiconsOutline.xMark : HeroiconsOutline.magnifyingGlass, color: Theme.of(context).hintColor),
                          onPressed: (){
                  ...
                  children: [
                    Container(
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                        border: expenseController.from != null && expenseController.to != null ? null : Border.all(color: Theme.of(context).hintColor.withValues(alpha: 0.4)),
                      ),
                      padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                      child: Icon(HeroiconsOutline.calendar, color: expenseController.from != null && expenseController.to != null ? Theme.of(context).cardColor : Theme.of(context).hintColor, size: 20),
                    ),
