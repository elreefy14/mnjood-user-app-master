import 'package:mnjood_vendor/features/expense/domain/models/expense_model.dart';
          ...
          child: Column(
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('amount'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                PriceConverter.convertPriceWithSvg(expense.amount, textStyle: robotoBold.copyWith(fontSize: 17)),
