...
import 'package:mnjood_vendor/features/home/widgets/trial_widget.dart';
...
import 'package:mnjood_vendor/helper/notification_helper.dart';
import 'package:mnjood_vendor/helper/route_helper.dart';
import 'package:mnjood_vendor/theme/dark_theme.dart';
import 'package:mnjood_vendor/theme/light_theme.dart';
import 'package:mnjood_vendor/util/app_constants.dart';
import 'package:mnjood_vendor/util/messages.dart';
    ...
    return GetBuilder<ThemeController>(builder: (themeController) {
      return GetBuilder<LocalizationController>(builder: (localizeController) {
        return GetMaterialApp(
          ...
          fallbackLocale: Locale(AppConstants.languages[0].languageCode ?? 'en', AppConstants.languages[0].countryCode ?? 'US'),
