...
import 'package:mnjood_delivery/common/widgets/code_picker_widget.dart';
      ...
      TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: widget.isPassword ? IconButton(
            icon: Icon(_obscureText ? HeroiconsOutline.eyeSlash : HeroiconsOutline.eye, color: Theme.of(context).hintColor),
            onPressed: _toggle,
          ) : null,
        ),
