        ...
        child: Align(
          ...
          child: Container(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(isError ? HeroiconsOutline.xCircle : HeroiconsOutline.checkCircle, color: isError ? const Color(0xffFF9090).withOpacity(0.5) : const Color(0xff039D55), size: 20),
