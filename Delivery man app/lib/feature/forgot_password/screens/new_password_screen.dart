          ...
          GetBuilder<ForgotPasswordController>(builder: (forgotPasswordController) {
            return Container(
              ...
              child: !forgotPasswordController.isLoading ? CustomButtonWidget(
                buttonText: 'save'.tr,
                backgroundColor: _newPasswordController.text.trim().isEmpty || _confirmPasswordController.text.trim().isEmpty ? Theme.of(context).disabledColor.withOpacity(0.2) : Theme.of(context).primaryColor,
