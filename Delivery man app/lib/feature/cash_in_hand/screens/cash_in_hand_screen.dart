...
import 'package:mnjood_delivery/feature/cash_in_hand/widgets/payment_method_bottom_sheet_widget.dart';
import 'package:mnjood_delivery/feature/cash_in_hand/widgets/wallet_attention_alert_widget.dart';
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  PriceConverter.convertPriceWithSvg(profileController.profileModel!.payableBalance, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).cardColor)),
                                ]),
                              ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                ...
                                PriceConverter.convertPriceWithSvg(profileController.profileModel!.cashInHands, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
                                ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                ...
                                PriceConverter.convertPriceWithSvg(profileController.profileModel!.totalWithdrawn, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
                                ),
                                const SizedBox(height: Dimensions.paddingSizeSmall),
