...
class OrderModel {
  ...
  int? chatCount;
  bool? hasActiveChat;
  String? arrivedAtStore;
  String? arrivedAtCustomer;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    arrivedAtStore = json['arrived_at_store'];
    arrivedAtCustomer = json['arrived_at_customer'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['arrived_at_store'] = arrivedAtStore;
    data['arrived_at_customer'] = arrivedAtCustomer;
    return data;
  }
}
...
class OrderCount {
  ...
  OrderCount.fromJson(Map<String, dynamic> json) {
    ...
    arrivedAtStore = json['arrived_at_store'] != null ? int.tryParse(json['arrived_at_store'].toString()) ?? 0 : 0;
    arrivedAtCustomer = json['arrived_at_customer'] != null ? int.tryParse(json['arrived_at_customer'].toString()) ?? 0 : 0;
  }
