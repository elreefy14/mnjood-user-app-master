    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Get.isDarkMode ? Colors.white.withOpacity(0.05) : Colors.black.withOpacity(0.05), blurRadius: 20, spreadRadius: 0, offset: Offset(0, 5))],
        ),
          ...
          Row(children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              widget.orderModel.paymentMethod == 'cash_on_delivery' ? Row(children: [
                ...
                (Get.find<SplashController>().configModel!.showDmEarning! && Get.find<ProfileController>().profileModel!.earnings == 1) ? PriceConverter.convertPriceWithSvg((widget.orderModel.originalDeliveryCharge ?? 0) + (widget.orderModel.dmTips ?? 0), textStyle: robotoBold, symbolSize: 12) : const SizedBox(),
              ...
              child: Row(children: [
                Column(children: [
                  Container(
                    ...
                    child: Icon(HeroiconsOutline.mapPin, color: Theme.of(context).hintColor, size: 16),
                  ),
                  ...
                  Container(
                    ...
                    child: Transform.rotate(
                      angle: -0.9,
                      child: Icon(HeroiconsOutline.paperAirplane, color: Theme.of(context).hintColor, size: 16),
                    ),
                  ),
                ]),
