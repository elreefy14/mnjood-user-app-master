...
import 'package:mnjood_delivery/feature/order/screens/order_location_screen.dart';
...
class OrderRequestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (orderModel.restaurantLat != null && orderModel.restaurantLng != null) {
      distance = Get.find<AddressController>().getRestaurantDistance(
            ...
            child: Column(children: [
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    '${orderModel.detailsCount ?? 1} ${(orderModel.detailsCount ?? 1) > 1 ? 'items'.tr : 'item'.tr}',
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    Text(
                      ...
                      style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.7)),
                    ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Theme.of(context).hintColor.withOpacity(0.15), borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                    ),
                    child: Row(children: [

                      (Get.find<SplashController>().configModel!.showDmEarning! && Get.find<ProfileController>().profileModel!.earnings == 1) ? PriceConverter.convertPriceWithSvg((orderModel.originalDeliveryCharge ?? 0) + (orderModel.dmTips ?? 0), textStyle: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                      ) : const SizedBox(),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        height: 5, width: 1, color: Theme.of(context).hintColor.withOpacity(0.5),
                      );
                    },
                  ),
                ),
