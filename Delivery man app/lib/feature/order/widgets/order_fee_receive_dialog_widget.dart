      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            PriceConverter.convertPriceWithSvg(totalAmount, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor), symbolSize: 14),
