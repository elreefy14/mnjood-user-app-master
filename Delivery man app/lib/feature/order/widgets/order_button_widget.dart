      ...
      child: Row(children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withOpacity(0.5),
          ),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                  color: isSelected ? Theme.of(context).cardColor.withOpacity(0.4) : Theme.of(context).cardColor,
                ),
                child: Text(
