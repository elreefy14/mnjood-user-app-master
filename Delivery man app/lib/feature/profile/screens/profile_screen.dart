...
import 'package:mnjood_delivery/feature/language/widgets/language_bottom_sheet_widget.dart';
...
import 'package:mnjood_delivery/feature/profile/widgets/profile_bg_widget.dart';
import 'package:mnjood_delivery/feature/profile/widgets/profile_button_widget.dart';
import 'package:mnjood_delivery/feature/profile/widgets/profile_card_widget.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _checkPermission() async {
    ...
    if(notificationStatus.isDenied || notificationStatus.isPermanentlyDenied) {
      ...
      Get.find<ProfileController>().setNotificationActive(true);
    }
  }
        ...
        return profileController.profileModel == null ? const Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          mainWidget: SingleChildScrollView(physics: const BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.moon, size: 25), title: 'dark_mode'.tr, isButtonActive: Get.isDarkMode, onTap: () {
                Get.find<ThemeController>().toggleTheme();
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              ProfileButtonWidget(
                icon: const Icon(HeroiconsOutline.bell, size: 25), title: 'system_notification'.tr,
                isButtonActive: profileController.notification, onTap: () async {
                  var notificationStatus = await Permission.notification.status;
              ...
              GetPlatform.isAndroid ? InkWell(
                ...
                child: DetailsCustomCard(
                  ...
                  child: Row(children: [
                    ...
                    const Icon(HeroiconsOutline.bellAlert, size: 25),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
              ...
              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.chatBubbleLeftRight, size: 25), title: 'conversation'.tr, onTap: () {
                Get.toNamed(RouteHelper.getConversationListRoute());
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.language, size: 25), title: 'language'.tr, onTap: () {
                _manageLanguageFunctionality();
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.lockClosed, size: 25), title: 'change_password'.tr, onTap: () {
                Get.toNamed(RouteHelper.getResetPasswordRoute('', '', 'password-change'));
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.pencilSquare, size: 25), title: 'edit_profile'.tr, onTap: () {
              ...
              (profileController.profileModel != null && profileController.profileModel!.earnings == 1) ? Padding(
                ...
                child: ProfileButtonWidget(icon: const Icon(HeroiconsOutline.buildingLibrary, size: 25), title: 'my_account'.tr, onTap: () {
                  Get.toNamed(RouteHelper.getCashInHandRoute());
                }),
              ) : const SizedBox(),

              (profileController.profileModel!.type != 'restaurant_wise' && profileController.profileModel!.earnings != 0) ? ProfileButtonWidget(icon: const Icon(HeroiconsOutline.gift, size: 25), title: 'incentive_offers'.tr, onTap: () {
              ...
              Column(children: [
                 ...
                 Padding(
                  padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall),
                  child: ProfileButtonWidget(icon: const Icon(HeroiconsOutline.creditCard, size: 25), title: 'disbursement'.tr, onTap: () {
                    Get.toNamed(RouteHelper.getDisbursementRoute());
                  }),
                ),

                ProfileButtonWidget(icon: const Icon(HeroiconsOutline.banknotes, size: 25), title: 'disbursement_methods'.tr, onTap: () {
              ...
              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.listBullet, size: 25), title: 'terms_condition'.tr, onTap: () {
                Get.toNamed(RouteHelper.getTermsRoute());
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.shieldCheck, size: 25), title: 'privacy_policy'.tr, onTap: () {
                Get.toNamed(RouteHelper.getPrivacyRoute());
              }),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              ProfileButtonWidget(
                icon: const Icon(HeroiconsOutline.trash, size: 25), title: 'delete_account'.tr,
                onTap: () {
              ...
              ProfileButtonWidget(icon: const Icon(HeroiconsOutline.arrowRightOnRectangle, size: 25), title: 'logout'.tr, onTap: () {
                showCustomBottomSheet(
                  child: CustomConfirmationBottomSheet(
                    cancelButtonText: 'no'.tr, confirmButtonText: 'yes'.tr,
                    title: 'logout'.tr,
