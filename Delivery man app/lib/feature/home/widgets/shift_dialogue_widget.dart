                  ...
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Row(children: [
                        ...
                        Icon(profileController.shifts![index].id == profileController.shiftId ? HeroiconsOutline.checkCircle : HeroiconsOutline.stop, color: Theme.of(context).primaryColor, size: 18),
