...
import 'package:mnjood_delivery/feature/auth/widgets/additional_data_section_widget.dart';
import 'package:mnjood_delivery/feature/forgot_password/widgets/pass_view_widget.dart';
import 'package:mnjood_delivery/helper/custom_validator.dart';
...
import 'package:mnjood_delivery/common/widgets/custom_dropdown_widget.dart';
...
import 'package:mnjood_delivery/common/models/config_model.dart';
import 'package:mnjood_delivery/feature/auth/domain/models/delivery_man_body_model.dart';
            ...
            child: Container(
              ...
              child: Row(spacing: Dimensions.paddingSizeSmall, children: [
                Expanded(
                  child: Container(
                    height: 4,
                    color: Get.find<AuthController>().dmStatus == 0.4 ? Theme.of(context).primaryColor.withOpacity(0.5) : Theme.of(context).primaryColor,
                  ),
                ),
                ...
                Expanded(
                  child: Container(
                    height: 4,
                    color: Get.find<AuthController>().dmStatus != 0.4 ? Theme.of(context).primaryColor.withOpacity(0.5) :  Get.find<AuthController>().dmStatus != 0.4 ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withOpacity(0.5),
                  ),
                ),
              ]),
            ),
                          ...
                          authController.vehicleIds != null ? Container(
                            ...
                            child: CustomDropdown<int>(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall),
                                child: Text(
                                  authController.vehicleIndex == 0 || authController.vehicleIndex! >= authController.vehicles!.length ? 'select_vehicle'.tr
