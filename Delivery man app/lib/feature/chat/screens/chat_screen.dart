...
import 'package:mnjood_delivery/feature/chat/widgets/conversation_details_shimmer_widget.dart';
...
import 'package:mnjood_delivery/feature/chat/widgets/message_bubble_widget.dart';
...
import 'package:mnjood_delivery/common/widgets/paginated_list_view_widget.dart';
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Row(children: [
              ...
              ClipOval(
                child: widget.notificationBody?.adminId != null && (chatController.messageModel == null || chatController.messageModel?.conversation?.receiver?.imageFullUrl == null)
                  ? Image.asset(Images.logo, fit: BoxFit.cover, height: 40, width: 40)
                  : Image.network(
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                chatController.messageModel != null ? Text(
                  widget.notificationBody?.adminId != null
                    ? (chatController.messageModel?.conversation?.receiver?.fName ?? Get.find<SplashController>().configModel?.businessName ?? 'Admin')
            ...
            child: Center(
              child: SizedBox(
                ...
                child: Column(children: [
                      ...
                      productView: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return MessageBubbleWidget(
                            ...
                            userType: widget.notificationBody!.adminId != null ? UserType.admin : widget.notificationBody!.customerId != null ? UserType.user : UserType.vendor,
                          );
                        },
                      ),
                    ),
                  ...
                  (chatController.messageModel != null && ((chatController.messageModel!.status ?? false) || chatController.messageModel!.messages!.isEmpty || widget.notificationBody?.adminId != null)) ? Container(
                    ...
                    child: Column(children: [
                      ...
                      chatController.pickedVideoFile != null ? Container(
                        ...
                        child: Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                          ...
                          const Icon(HeroiconsOutline.videoCamera, size: 30),
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Icon(HeroiconsOutline.xMark, color: Theme.of(context).cardColor, size: 15),
                                      ),
                                    ),
                                  ),
                                ),
                              ...
                              child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                ...
                                MenuAnchor(
                                  ...
                                  menuChildren: List<MenuItemButton>.generate(2, (int index) => MenuItemButton(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(index == 0 ? HeroiconsOutline.document : HeroiconsOutline.videoCamera, size: 18, color: Theme.of(context).primaryColor),
                                        const SizedBox(width: Dimensions.paddingSizeSmall),
