...
import 'package:mnjood_delivery/feature/chat/widgets/search_field_widget.dart';
...
import 'package:mnjood_delivery/common/widgets/custom_ink_well_widget.dart';
...
class _ConversationScreenState extends State<ConversationScreen> with TickerProviderStateMixin{
          ...
          child: Column(children: [
            ...
            Expanded(child: RefreshIndicator(
              ...
              child: CustomScrollView(controller: _scrollController, slivers: [
                ...
                SliverToBoxAdapter(
                  child: _buildAdminChatCard(chatController),
                ),
  ...
  Widget _buildAdminChatCard(ChatController chatController) {
    String businessName = Get.find<SplashController>().configModel?.businessName ?? 'Admin';
    Conversation? adminConversation = chatController.adminConversationModel;

    String? lastMessage;
    int unreadCount = 0;
    if (adminConversation != null) {
      lastMessage = adminConversation.lastMessage?.message;
      unreadCount = adminConversation.unreadMessageCount ?? 0;
    }
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(businessName, style: robotoBold),
                ...
                Text(
                  lastMessage ?? 'chat_with_admin'.tr,
