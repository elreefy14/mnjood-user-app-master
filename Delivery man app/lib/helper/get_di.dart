import 'dart:convert';
import 'package:mnjood_delivery/feature/auth/controllers/address_controller.dart';
import 'package:mnjood_delivery/feature/auth/controllers/auth_controller.dart';
import 'package:mnjood_delivery/feature/forgot_password/controllers/forgot_password_controller.dart';
import 'package:mnjood_delivery/feature/auth/domain/repositories/address_repository.dart';
import 'package:mnjood_delivery/feature/auth/domain/repositories/address_repository_interface.dart';
import 'package:mnjood_delivery/feature/auth/domain/repositories/auth_repository.dart';
import 'package:mnjood_delivery/feature/auth/domain/repositories/auth_repository_interface.dart';
import 'package:mnjood_delivery/feature/forgot_password/domain/repositories/forgot_password_repository.dart';
import 'package:mnjood_delivery/feature/forgot_password/domain/repositories/forgot_password_repository_interface.dart';
import 'package:mnjood_delivery/feature/auth/domain/services/address_service.dart';
import 'package:mnjood_delivery/feature/auth/domain/services/address_service_interface.dart';
import 'package:mnjood_delivery/feature/auth/domain/services/auth_service.dart';
import 'package:mnjood_delivery/feature/auth/domain/services/auth_service_interface.dart';
import 'package:mnjood_delivery/feature/forgot_password/domain/services/forgot_password_service.dart';
import 'package:mnjood_delivery/feature/forgot_password/domain/services/forgot_password_service_interface.dart';
import 'package:mnjood_delivery/feature/cash_in_hand/controllers/cash_in_hand_controller.dart';
import 'package:mnjood_delivery/feature/cash_in_hand/domain/repositories/cash_in_hand_repository.dart';
import 'package:mnjood_delivery/feature/cash_in_hand/domain/repositories/cash_in_hand_repository_interface.dart';
import 'package:mnjood_delivery/feature/cash_in_hand/domain/services/cash_in_hand_service.dart';
import 'package:mnjood_delivery/feature/cash_in_hand/domain/services/cash_in_hand_service_interface.dart';
import 'package:mnjood_delivery/feature/disbursements/controllers/disbursement_controller.dart';
import 'package:mnjood_delivery/feature/disbursements/domain/repositories/disbursement_repository.dart';
import 'package:mnjood_delivery/feature/disbursements/domain/repositories/disbursement_repository_interface.dart';
import 'package:mnjood_delivery/feature/disbursements/domain/services/disbursement_service.dart';
import 'package:mnjood_delivery/feature/disbursements/domain/services/disbursement_service_interface.dart';
import 'package:mnjood_delivery/feature/language/controllers/localization_controller.dart';
import 'package:mnjood_delivery/feature/language/domain/repositories/language_repository.dart';
import 'package:mnjood_delivery/feature/language/domain/repositories/language_repository_interface.dart';
import 'package:mnjood_delivery/feature/language/domain/services/language_service.dart';
import 'package:mnjood_delivery/feature/language/domain/services/language_service_interface.dart';
...
import 'package:mnjood_delivery/feature/notification/domain/repositories/notification_repository.dart';
import 'package:mnjood_delivery/feature/notification/domain/repositories/notification_repository_interface.dart';
import 'package:mnjood_delivery/feature/notification/domain/services/notification_service.dart';
import 'package:mnjood_delivery/feature/notification/domain/services/notification_service_interface.dart';
import 'package:mnjood_delivery/feature/order/domain/repositories/order_repository.dart';
import 'package:mnjood_delivery/feature/order/domain/repositories/order_repository_interface.dart';
import 'package:mnjood_delivery/feature/order/domain/services/order_service.dart';
...
import 'package:mnjood_delivery/common/controllers/theme_controller.dart';
...
import 'package:mnjood_delivery/feature/order_chat/domain/repositories/order_chat_repository.dart';
import 'package:mnjood_delivery/feature/order_chat/domain/repositories/order_chat_repository_interface.dart';
import 'package:mnjood_delivery/feature/order_chat/domain/services/order_chat_service.dart';
import 'package:mnjood_delivery/feature/order_chat/domain/services/order_chat_service_interface.dart';
import 'package:mnjood_delivery/feature/chat/domain/repositories/chat_repository.dart';
import 'package:mnjood_delivery/feature/chat/domain/repositories/chat_repository_interface.dart';
import 'package:mnjood_delivery/feature/chat/domain/services/chat_service.dart';
import 'package:mnjood_delivery/feature/chat/domain/services/chat_service_interface.dart';
import 'package:mnjood_delivery/feature/profile/controllers/profile_controller.dart';
import 'package:mnjood_delivery/feature/profile/domain/repositories/profile_repository.dart';
import 'package:mnjood_delivery/feature/profile/domain/repositories/profile_repository_interface.dart';
import 'package:mnjood_delivery/feature/profile/domain/services/profile_service.dart';
import 'package:mnjood_delivery/feature/profile/domain/services/profile_service_interface.dart';
import 'package:mnjood_delivery/feature/splash/domain/repositories/splash_repository.dart';
import 'package:mnjood_delivery/feature/splash/domain/repositories/splash_repository_interface.dart';
import 'package:mnjood_delivery/feature/splash/domain/services/splash_service.dart';
import 'package:mnjood_delivery/feature/splash/domain/services/splash_service_interface.dart';
import 'package:mnjood_delivery/util/app_constants.dart';
import 'package:mnjood_delivery/feature/language/domain/models/language_model.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  OrderChatRepositoryInterface orderChatRepositoryInterface = OrderChatRepository(apiClient: Get.find(), sharedPreferences: Get.find());
