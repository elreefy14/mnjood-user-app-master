...
class AppConstants {
  static const String appName = 'Mnjood Delivery';
  ...
  /// Order Chat
  static const String orderChatListUri = '/api/v1/delivery-man/order-chat/list';
  static const String orderChatSendUri = '/api/v1/delivery-man/order-chat/send';
  static const String orderChatMarkReadUri = '/api/v1/delivery-man/order-chat/mark-read';

  // Shared Key
  static const String theme = 'theme';
  static const String token = 'mnjood_delivery_token';
