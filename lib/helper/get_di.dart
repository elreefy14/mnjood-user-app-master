...
import 'package:mnjood/features/dashboard/domain/repositories/dashboard_repo.dart';
...
import 'package:mnjood/features/dine_in/domain/repositories/dine_in_repository.dart';
import 'package:mnjood/features/dine_in/domain/repositories/dine_in_repository_interface.dart';
import 'package:mnjood/features/dine_in/domain/services/dine_in_service.dart';
...
import 'package:mnjood/features/home/domain/repositories/advertisement_repository.dart';
import 'package:mnjood/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:mnjood/features/home/domain/services/advertisement_service.dart';
...
import 'package:mnjood/features/cart/domain/repositories/cart_repository.dart';
import 'package:mnjood/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:mnjood/features/cart/domain/services/cart_service.dart';
...
import 'package:mnjood/features/chat/domain/repositories/chat_repository.dart';
import 'package:mnjood/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:mnjood/features/chat/domain/services/chat_service.dart';
...
import 'package:mnjood/features/order_chat/domain/repositories/order_chat_repository.dart';
import 'package:mnjood/features/order_chat/domain/repositories/order_chat_repository_interface.dart';
import 'package:mnjood/features/order_chat/domain/services/order_chat_service.dart';
...
import 'package:mnjood/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:mnjood/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:mnjood/features/checkout/domain/services/checkout_service.dart';
...
import 'package:mnjood/features/home/domain/repositories/home_repository.dart';
import 'package:mnjood/features/home/domain/repositories/home_repository_interface.dart';
import 'package:mnjood/features/home/domain/services/home_service.dart';
...
import 'package:mnjood/features/order/domain/repositories/order_repository.dart';
import 'package:mnjood/features/order/domain/repositories/order_repository_interface.dart';
import 'package:mnjood/features/order/domain/services/order_service.dart';
import 'package:mnjood/features/order/domain/services/order_service_interface.dart';
import 'package:mnjood/features/product/domain/repositories/campaign_repository.dart';
import 'package:mnjood/features/product/domain/repositories/campaign_repository_interface.dart';
import 'package:mnjood/features/product/domain/services/campaign_service.dart';
...
import 'package:mnjood/features/html/domain/repositories/html_repository.dart';
import 'package:mnjood/features/html/domain/repositories/html_repository_interface.dart';
import 'package:mnjood/features/html/domain/services/html_service.dart';
...
import 'package:mnjood/features/language/domain/repository/language_repository.dart';
import 'package:mnjood/features/language/domain/repository/language_repository_interface.dart';
import 'package:mnjood/features/language/domain/service/language_service.dart';
...
import 'package:mnjood/features/notification/domain/repository/notification_repository.dart';
import 'package:mnjood/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:mnjood/features/notification/domain/service/notification_service.dart';
...
import 'package:mnjood/features/onboard/domain/repository/onboard_repository.dart';
import 'package:mnjood/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:mnjood/features/onboard/domain/service/notification_service.dart';
...
import 'package:mnjood/features/profile/domain/repositories/profile_repository.dart';
import 'package:mnjood/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:mnjood/features/profile/domain/services/profile_service.dart';
...
import 'package:mnjood/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:mnjood/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:mnjood/features/restaurant/domain/services/restaurant_service.dart';
import 'package:mnjood/features/restaurant/domain/services/restaurant_service_interface.dart';
import 'package:mnjood/features/search/controllers/search_controller.dart';
import 'package:mnjood/features/search/domain/repositories/search_repository.dart';
import 'package:mnjood/features/search/domain/repositories/search_repository_interface.dart';
import 'package:mnjood/features/search/domain/services/search_service.dart';
...
import 'package:mnjood/features/address/domain/reposotories/address_repo.dart';
import 'package:mnjood/features/address/domain/reposotories/address_repo_interface.dart';
import 'package:mnjood/features/address/domain/services/address_service.dart';
...
import 'package:mnjood/features/auth/domain/reposotories/auth_repo.dart';
import 'package:mnjood/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:mnjood/features/auth/domain/reposotories/deliveryman_registration_repo.dart';
import 'package:mnjood/features/auth/domain/reposotories/deliveryman_registration_repo_interface.dart';
import 'package:mnjood/features/auth/domain/reposotories/restaurant_registration_repo.dart';
import 'package:mnjood/features/auth/domain/reposotories/restaurant_registration_repo_interface.dart';
import 'package:mnjood/features/auth/domain/services/auth_service.dart';
import 'package:mnjood/features/auth/domain/services/auth_service_interface.dart';
import 'package:mnjood/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:mnjood/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:mnjood/features/auth/domain/services/restaurant_registration_service.dart';
...
import 'package:mnjood/features/business/domain/reposotories/business_repo.dart';
import 'package:mnjood/features/business/domain/reposotories/business_repo_interface.dart';
import 'package:mnjood/features/business/domain/services/business_service.dart';
...
import 'package:mnjood/features/category/domain/reposotories/category_repository.dart';
import 'package:mnjood/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:mnjood/features/category/domain/services/category_service.dart';
import 'package:mnjood/features/category/domain/services/category_service_interface.dart';
import 'package:mnjood/features/coupon/domain/reposotories/coupon_repository.dart';
import 'package:mnjood/features/coupon/domain/reposotories/coupon_repository_interface.dart';
import 'package:mnjood/features/coupon/domain/services/coupon_service.dart';
...
import 'package:mnjood/features/cuisine/domain/repositories/cuisine_repository.dart';
import 'package:mnjood/features/cuisine/domain/repositories/cuisine_repository_interface.dart';
import 'package:mnjood/features/cuisine/domain/services/cuisine_service.dart';
...
import 'package:mnjood/features/dashboard/domain/services/dashboard_service.dart';
...
import 'package:mnjood/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:mnjood/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:mnjood/features/favourite/domain/services/favourite_service.dart';
...
import 'package:mnjood/features/interest/domain/repositories/interest_repository.dart';
import 'package:mnjood/features/interest/domain/repositories/interest_repository_interface.dart';
import 'package:mnjood/features/interest/domain/services/interest_service.dart';
...
import 'package:mnjood/features/location/domain/reposotories/location_repo.dart';
import 'package:mnjood/features/location/domain/reposotories/location_repo_interface.dart';
import 'package:mnjood/features/location/domain/services/location_service.dart';
...
import 'package:mnjood/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:mnjood/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:mnjood/features/loyalty/domain/services/loyalty_service.dart';
...
import 'package:mnjood/features/product/domain/repositories/product_repository.dart';
import 'package:mnjood/features/product/domain/repositories/product_repository_interface.dart';
import 'package:mnjood/features/product/domain/services/product_service.dart';
...
import 'package:mnjood/features/review/domain/repositories/review_repository.dart';
import 'package:mnjood/features/review/domain/repositories/review_repository_interface.dart';
import 'package:mnjood/features/review/domain/services/review_service.dart';
import 'package:mnjood/features/review/domain/services/review_service_interface.dart';
import 'package:mnjood/features/splash/domain/repositories/splash_repository.dart';
import 'package:mnjood/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:mnjood/features/splash/domain/services/splash_service.dart';
...
import 'package:mnjood/features/verification/domein/reposotories/verification_repo.dart';
import 'package:mnjood/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:mnjood/features/verification/domein/services/verification_service.dart';
...
import 'package:mnjood/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:mnjood/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:mnjood/features/wallet/domain/services/wallet_service.dart';
