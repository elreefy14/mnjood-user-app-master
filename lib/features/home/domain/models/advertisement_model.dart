...
class AdvertisementModel {
  ...
  AdvertisementModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    restaurantId = json['restaurant_id'] ?? json['resource_id'] ?? json['vendor_id'];
    ...
    // V3 API returns booleans, convert to int for compatibility
    isRatingActive = _boolToInt(json['is_rating_active']);
    isReviewActive = _boolToInt(json['is_review_active']);
    isPaid = _boolToInt(json['is_paid']);
