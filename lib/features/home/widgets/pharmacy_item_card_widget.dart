...
/// Pharmacy-specific product card with health theme
class PharmacyItemCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: CustomInkWellWidget(
        ...
        child: Column(
          children: [
            // Image section - use LayoutBuilder to get actual size
            Expanded(
              flex: 55,
              child: LayoutBuilder(
                      ...
                      Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: CustomImageWidget(
                            ...
                            height: constraints.maxHeight - (isCampaignItem ? 0 : Dimensions.paddingSizeExtraSmall * 2),
                            width: constraints.maxWidth - (isCampaignItem ? 0 : Dimensions.paddingSizeExtraSmall * 2),
                            fit: BoxFit.cover,
                            isFood: true,
                          ),
                        ),
        ...
        if (isCampaignItem) {
          ...
          if (product.variations == null || (product.variations != null && product.variations!.isEmpty)) {
            ...
            OnlineCart onlineCart = OnlineCart(
              ...
              'Food',
              variationOptionIds: [],
              vendorId: vendorId ?? product.pharmacyId,
              vendorType: 'pharmacy',
            );
