import 'package:mnjood/features/home/widgets/category_pop_up_widget.dart';
...
class CategoryWidget1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<HomeController>(builder: (homeController) {
      ...
      return (categoryList != null && categoryList.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            padding: const EdgeInsets.fromLTRB(10, 10, 10, 10),
            child: TitleWidget(title: 'categories'.tr, onTap: () => Get.toNamed(RouteHelper.getCategoryRoute(businessType: 'restaurant'))),
          ),
          Row(
            children: [
              Expanded(
                child: SizedBox(
                  ...
                  child: categoryList != null ? ListView.builder(
                    ...
                    itemCount: categoryList.length > 15 ? 15 : categoryList.length,
                            ...
                            child: Container(
                              ...
                              child: Stack(children: [
                                ...
                                Positioned(bottom: 0, left: 0, right: 0, child: Container(
                                  ...
                                  child: Text(
                                    categoryList[index].name!, maxLines: 1, overflow: TextOverflow.ellipsis,
              ...
              ResponsiveHelper.isMobile(context) ? const SizedBox() : categoryList != null ? Column(
                children: [
                  InkWell(
                    onTap: (){
              ...
              ): CategoryAllShimmer(isLoading: categoryList == null)
            ],
          ),
...
class CategoryAllShimmer extends StatelessWidget {
  final bool isLoading;
  const CategoryAllShimmer({super.key, required this.isLoading});
