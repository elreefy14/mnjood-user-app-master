            ...
            child: restaurant != null ? ListView.builder(
              ...
              itemBuilder: (context, index){
                return Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      RouteHelper.navigateToStoreOrShowClosedDialog(restaurant[index], context, businessType: restaurant[index].businessType);
                    },
                    child: Container(
                      height: 150,
                      width: 200,
                            ...
                            child: GetBuilder<FavouriteController>(builder: (favouriteController) {
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Icon(
                                    isWished ? HeroiconsSolid.heart : HeroiconsOutline.heart,  size: 15,
