        ...
        child: Stack(
          ...
          children: [
            ...
            !isAvailable ? Positioned(top: 10, left: 10, child: Container(
              ...
              child: Row(children: [
                Icon(HeroiconsOutline.clock, size: 12, color: Theme.of(context).cardColor),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      (restaurant.ratingCount ?? 0) > 0 ? IconWithTextRowWidget(
                        icon: HeroiconsSolid.star, text: (restaurant.avgRating ?? 0).toStringAsFixed(1),
                        style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                      ) : const SizedBox(),
                      SizedBox(width: (restaurant.ratingCount ?? 0) > 0 ? Dimensions.paddingSizeDefault : 0),

                      (restaurant.freeDelivery ?? false) ? ImageWithTextRowWidget(
                        widget: Image.asset(Images.deliveryIcon, height: 20, width: 20),
                        text: 'free'.tr,
                        style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                      ) : const SizedBox(),
                      SizedBox(width: (restaurant.freeDelivery ?? false) ? Dimensions.paddingSizeDefault : 0),

                      IconWithTextRowWidget(
                        icon: HeroiconsOutline.clock, text: '${restaurant.deliveryTime}',
                        style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                      ),
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text('${Get.find<RestaurantController>().getRestaurantDistance(
                      LatLng(double.tryParse(restaurant.latitude ?? '0') ?? 0, double.tryParse(restaurant.longitude ?? '0') ?? 0),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      IconWithTextRowWidget(
                        icon: HeroiconsOutline.star, text: '0.0',
                        color: Theme.of(context).shadowColor,
                      ...
                      IconWithTextRowWidget(
                        icon: HeroiconsOutline.clock, text: '10-30 min',
                        color: Theme.of(context).shadowColor,
                        style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).shadowColor),
                      ),
