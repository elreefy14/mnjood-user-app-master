...
class WebCuisineViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CuisineController>(builder: (cuisineController) {
      return (cuisineController.cuisineModel != null && (cuisineController.cuisineModel!.cuisines?.isEmpty ?? true)) ? const SizedBox() : Padding(
              ...
              Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('cuisine'.tr, style: sectionTitleStyle),
                  ),
