...
class TopRestaurantsViewWidget extends StatefulWidget {
  const TopRestaurantsViewWidget({super.key});

  @override
  State<TopRestaurantsViewWidget> createState() => _TopRestaurantsViewWidgetState();
}

class _TopRestaurantsViewWidgetState extends State<TopRestaurantsViewWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      // Use dedicated top restaurants list
      List<Restaurant>? restaurantList = restController.topRestaurantList;
          ...
          child: Column(
            ...
            children: [
              EnterpriseSectionHeaderWidget(
                title: 'top_rated_restaurants'.tr,
                trailing: ArrowIconButtonWidget(onTap: () {
                  Get.toNamed(RouteHelper.getBusinessCategoryRoute('restaurant'));
                }),
              ),
      ...
      final filteredList = _applyFilters(restaurantList);
              ...
              : SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _buildRestaurantCard(context, filteredList[index], restController);
                    },
                  ),
                ),
          ],
  ...
  Widget _buildRestaurantCard(BuildContext context, Restaurant restaurant, RestaurantController restController) {
