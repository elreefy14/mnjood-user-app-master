...
class PopularRestaurantsViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      // Filter to show only restaurants (not pharmacies, supermarkets, etc.)
      List<Restaurant>? restaurantList = isRecentlyViewed
          ? restController.recentlyViewedRestaurantList?.where((r) =>
              r.businessType == null || r.businessType == 'restaurant' || r.businessType == 'food'
            ).toList()
          : restController.popularRestaurantList?.where((r) =>
              r.businessType == null || r.businessType == 'restaurant' || r.businessType == 'food'
            ).toList();

      return (restaurantList != null && restaurantList.isEmpty) ? const SizedBox() : Container(
          ...
          children: [
            ...
            ResponsiveHelper.isDesktop(context)
              ...
              : EnterpriseSectionHeaderWidget(
                  ...
                  title: isRecentlyViewed ? 'recently_viewed_restaurants'.tr : 'popular_restaurants'.tr,
            ...
            restaurantList != null ? SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _buildRestaurantCard(context, restaurantList[index], restController);
                },
              ),
                  ...
                  PositionedDirectional(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Icon(HeroiconsSolid.cake, size: 10, color: Colors.white),
