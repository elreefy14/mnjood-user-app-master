                    ...
                    Theme(
                      ...
                      child: Container(
                        ...
                        child: ExpansionTile(
                          ...
                          trailing: Icon(HeroiconsOutline.chevronDown, size: 35 , color: Theme.of(context).textTheme.bodyMedium!.color),
...
class InfoTextRowWidget extends StatelessWidget {
  ...
  /// Translates common bank field names from API to localized strings
  String _translateFieldName(String fieldName) {
    // Normalize the field name: lowercase and replace spaces/underscores
    String normalized = fieldName.toLowerCase().replaceAll(' ', '_').replaceAll('-', '_');

    // Map of common bank field names to translation keys
    const Map<String, String> fieldTranslations = {
      'bank_name': 'bank_name',
      'bankname': 'bank_name',
    ...
    if (fieldTranslations.containsKey(normalized)) {
      return fieldTranslations[normalized]!.tr;
    }

    // Return original with underscores replaced by spaces if no translation found
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      Expanded(
        ...
        child: Text(_translateFieldName(title), style: robotoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
      ),
