...
abstract class CheckoutServiceInterface {
  ...
  Future<Response> placeOrder(PlaceOrderBodyModel orderBody, {XFile? prescriptionImage});
  ...
  Future<Response> verifyMoyasarPayment(String orderId, String paymentId);
  Future<Response> initializePaymentSession(Map<String, dynamic> data);
}