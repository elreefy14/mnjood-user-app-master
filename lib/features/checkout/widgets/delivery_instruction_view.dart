...
import 'package:mnjood/features/checkout/widgets/delivery_instruction_bottom_sheet.dart';
...
class _DeliveryInstructionViewState extends State<DeliveryInstructionView> {
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          InkWell(
            ...
            child: Row(children: [
              ...
              const Icon(HeroiconsOutline.chevronDown, size: 20),
            ]),
          ),
    ...
    //             trailing: Icon(checkoutController.isExpanded ? HeroiconsOutline.minus : HeroiconsOutline.plus, size: 18),
    ...
    //                       child: Row(
    //                         children: [
    //                           Icon(HeroiconsOutline.sparkles, color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor, size: 18),
