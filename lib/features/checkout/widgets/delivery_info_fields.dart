            ...
            Padding(
              ...
              child: Row(children: [
                checkoutController.guestAddress == null ? Flexible(
                  child: Row(
                    children: [
                      ...
                      Icon(HeroiconsOutline.exclamationCircle, color: Theme.of(context).colorScheme.error, size: 15),
                  ...
                  child: Row(children: [
                    ...
                    Flexible(
                      flex: 4,
                      child: Row(children: [
                        Icon(HeroiconsOutline.user, color: Theme.of(context).disabledColor, size: 20),
                    ...
                    Flexible(
                      flex: 6,
                      child: Row(children: [
                        Icon(HeroiconsOutline.phone, color: Theme.of(context).disabledColor, size: 20),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                ...
                takeAway ? const SizedBox() : InkWell(
                  onTap: () async {
                    var addressResult = await Get.toNamed(RouteHelper.getEditAddressRoute(checkoutController.guestAddress, fromGuest: true));
                    if(addressResult != null) {
                      checkoutController.setGuestAddress(addressResult);
                      final restaurantLat = checkoutController.restaurant?.latitude;
                      final restaurantLng = checkoutController.restaurant?.longitude;
                      if (restaurantLat != null && restaurantLng != null) {
                        checkoutController.getDistanceInKM(
                          LatLng(double.parse(addressResult.latitude), double.parse(addressResult.longitude)),
                          LatLng(double.parse(restaurantLat), double.parse(restaurantLng)),
                        );
                      }
                    }
                  },
