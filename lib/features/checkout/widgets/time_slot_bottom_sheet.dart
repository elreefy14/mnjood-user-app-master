...
import 'package:mnjood/features/checkout/domain/models/date_month_body_model.dart';
import 'package:mnjood/features/checkout/widgets/slot_widget.dart';
...
class _TimeSlotBottomSheetState extends State<TimeSlotBottomSheet> {
  ...
  void initState() {
    ...
    _instanceOrder = (configModel?.instantOrder ?? false) && (widget.restaurant.instantOrder ?? false);
            ...
            return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  (isRestaurantSelfDeliveryOn ? (widget.restaurant.customerDateOrderStatus ?? false) : (Get.find<SplashController>().configModel?.customerDateOrderStatus ?? false)) ? Expanded(
                    ...
                    selectedDateSlotIndex == 2 ? Column(children: [
                      ...
                      SfDateRangePicker(
                        ...
                        selectableDayPredicate: (DateTime val) {
                          final customerOrderDate = isRestaurantSelfDeliveryOn
                              ? (widget.restaurant.customerOrderDate ?? 7)
                              : (Get.find<SplashController>().configModel?.customerOrderDate ?? 7);
                          return _canSelectDate(duration: customerOrderDate, value: val);
                        },
                      ),
