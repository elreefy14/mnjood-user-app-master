      ...
      child: SizedBox(width: 500, child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          GetBuilder<OrderController>(builder: (orderController) {
            ...
            final cashOnDelivery = configModel?.cashOnDelivery ?? false;
            final loyaltyPoint = configModel?.loyaltyPointItemPurchasePoint ?? 0;

            return !orderController.isLoading ? Column(children: [
              cashOnDelivery ? CustomButtonWidget(
                buttonText: 'switch_to_cash_on_delivery'.tr,
                onPressed: () {
                  if(maxCodOrderAmount == null || (orderAmount != null && orderAmount! < maxCodOrderAmount!)){
                    double total = (((orderAmount ?? 0) / 100) * loyaltyPoint);
              ...
              SizedBox(height: cashOnDelivery ? Dimensions.paddingSizeLarge : 0),
