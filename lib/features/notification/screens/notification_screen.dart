...
import 'package:mnjood/features/notification/widgets/add_fund_bottom_sheet.dart';
import 'package:mnjood/features/notification/widgets/notification_bottom_sheet.dart';
import 'package:mnjood/features/notification/widgets/notification_dialog_widget.dart';
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            if(notificationController.notificationList![index].data!.type == 'push_notification' || notificationController.notificationList![index].data!.type == 'referral_code'
                              ...
                              Get.toNamed(RouteHelper.getOrderDetailsRoute(notificationController.notificationList![index].data!.orderId!, fromNotification: true));
