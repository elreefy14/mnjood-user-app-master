...
class NotificationBodyModel {
  ...
  NotificationType convertToEnum(String? enumString) {
    ...
    }else if(enumString == NotificationType.product_substitution.toString()) {
      return NotificationType.product_substitution;
    }else if(enumString == NotificationType.wallet_refund.toString()) {
      return NotificationType.wallet_refund;
    }else if(enumString == NotificationType.order_chat_message.toString()) {
      return NotificationType.order_chat_message;
    }
    return NotificationType.general;
  }
