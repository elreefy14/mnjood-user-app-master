...
class ExtraPackagingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restaurantController) {
      ...
      return (restaurant != null && (restaurant.isExtraPackagingActive ?? false) && restaurant.extraPackagingAmount != null && restaurant.extraPackagingAmount != 0 && !(restaurant.extraPackagingStatusIsMandatory ?? false)) ? Container(
        ...
        child: Row(children: [
          ...
          PriceConverter.convertPriceWithSvg(restaurantController.restaurant?.extraPackagingAmount, textStyle: robotoMedium),
