...
class SearchService implements SearchServiceInterface {
  ...
  Future<Response> getSearchData({
    ...
    return await searchRepositoryInterface.getSearchData(
      query: query,
      ...
      isNew: isNew,
      isPopular: isPopular,
      isOneRatting: isOneRatting,
      isTwoRatting: isTwoRatting,
      isThreeRatting: isThreeRatting,
      isFourRatting: isFourRatting,
      isFiveRatting: isFiveRatting,
      sortBy: sortBy,
      discounted: discounted,
      minPrice: minPrice,
      maxPrice: maxPrice,
      selectedCuisines: selectedCuisines,
      isOpenRestaurant: isOpenRestaurant,
  ...
  Future<Response> searchVendorsByType({
    ...
    return await searchRepositoryInterface.searchVendorsByType(
      query: query,
      businessType: businessType,
      offset: offset,
      type: type,
  ...
  Future<Response> searchProductsByBusinessType({
    ...
    return await searchRepositoryInterface.searchProductsByBusinessType(
      query: query,
      businessType: businessType,
      offset: offset,
      type: type,
