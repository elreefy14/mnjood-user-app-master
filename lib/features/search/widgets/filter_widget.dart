...
import 'package:mnjood/features/search/widgets/custom_check_box_widget.dart';
...
class FilterWidget extends StatefulWidget {
  ...
  const FilterWidget({super.key, required this.maxValue, required this.minValue, required this.isRestaurant, this.businessType});
          ...
          Flexible(
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                //             },
                //             child: Icon(
                //               (widget.isRestaurant ? searchController.restaurantRating < (index + 1) : searchController.rating < (index + 1)) ? HeroiconsOutline.star : HeroiconsSolid.star,
                //               size: 34,
                                ...
                                return InkWell(
                                  ...
                                  child: Center(child: Row(
                                    ...
                                    children: [
                                      ...
                                      Icon(HeroiconsOutline.chevronDown, color: Theme.of(context).primaryColor),
                                    ],
                                  )),
                                );
                              } else {
              ...
              child: Row(children: [
                Expanded(
                  child: CustomButtonWidget(
                    ...
                    onPressed: () {
                      ...
                      Get.back();
                      // Pass businessType when clearing filters to maintain context
                      searchController.searchData1(searchController.searchText, 1, businessType: widget.businessType);
                    },
                ...
                Expanded(
                  child: CustomButtonWidget(
                    ...
                    onPressed: () async {
                      Get.back();
                      // Pass businessType when applying filters to maintain context
                      searchController.searchData1(searchController.searchText, 1, businessType: widget.businessType);
                    },
                  ),
                ),
