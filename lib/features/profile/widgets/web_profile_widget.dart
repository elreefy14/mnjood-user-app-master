...
import 'package:mnjood/features/profile/widgets/notification_status_change_bottom_sheet.dart';
import 'package:mnjood/features/profile/widgets/profile_button_widget.dart';
import 'package:mnjood/features/profile/widgets/profile_card_widget.dart';
        ...
        child: Column(children : [
          ...
          GridView.count(
            ...
            children: <Widget>[
              ...
              ProfileButtonWidget(icon: HeroiconsOutline.moon, title: 'dark_mode'.tr, isButtonActive: Get.isDarkMode, onTap: () {
                Get.find<ThemeController>().toggleTheme();
              }),

              isLoggedIn ? GetBuilder<AuthController>(builder: (authController) {
                return ProfileButtonWidget(
                  icon: HeroiconsOutline.bell, title: 'notification'.tr,
              ...
              isLoggedIn ? ProfileButtonWidget(icon: HeroiconsOutline.lockClosed, title: 'change_password'.tr, onTap: () {
                Get.dialog(NewPassScreen(fromPasswordChange: true, fromDialog: true, resetToken: '', number: ''));
              }) : const SizedBox(),

              isLoggedIn ? ProfileButtonWidget(icon: HeroiconsOutline.pencilSquare, title: 'edit_profile'.tr, onTap: () {
