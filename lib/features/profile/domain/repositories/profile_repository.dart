...
import 'package:mnjood/features/profile/domain/models/update_profile_response_model.dart';
...
import 'package:mnjood/features/profile/domain/repositories/profile_repository_interface.dart';
...
class ProfileRepository implements ProfileRepositoryInterface {
  ...
  Future<ResponseModel> updateProfile(UpdateUserModel userInfoModel, XFile? data, String tokeni) async {
    ...
    Response response = await apiClient.postMultipartData(AppConstants.updateProfileUri, userInfoModel.toJson(), [MultipartBody('image', data)], [], handleError: false, method: 'PATCH');
  ...
  @override
  Future<Response> delete(int? id, {String? password}) async {
    return await apiClient.postData(AppConstants.customerRemoveUri, {"_method": "delete", "password": password});
  }
