            ...
            actions: [
              isLoggedIn ? PopupMenuButton(
                itemBuilder: (context) {
                  return <PopupMenuEntry>[
                    PopupMenuItem(
                      value: 'delete',
                      child: Row(children: [
                        Icon(HeroiconsOutline.trash, color: Colors.red, size: 20),
                ...
                child: const Padding(
                  ...
                  child: Icon(HeroiconsOutline.ellipsisVertical, size: 25),
                ),
              ...
              Expanded(child: SingleChildScrollView(
                ...
                child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Center(child: Stack(children: [
                    ClipOval(child: profileController.pickedFile != null && profileController.pickedFileBytes != null
                      ? GetPlatform.isWeb
                        ? Image.memory(profileController.pickedFileBytes!, width: 100, height: 100, fit: BoxFit.cover)
                  ...
                  !_isPhoneLoading ? Stack(
                    children: [
                      CustomTextFieldWidget(
                        ...
                        prefixIcon: HeroiconsSolid.lockClosed,
