...
import 'package:mnjood/features/profile/widgets/web_profile_widget.dart';
                        ...
                        child: Row(children: [
                          ...
                          isLoggedIn ? InkWell(
                            ...
                            child: Container(
                              ...
                              child: Icon(HeroiconsOutline.pencilSquare, size: 24, color: Theme.of(context).primaryColor),
                            ),
                          ) : InkWell(
                            onTap: () async {
                              if(!isDesktop) {
                          ...
                          child: Column(children: [
                            ...
                            isLoggedIn ? GetBuilder<AuthController>(builder: (authController) {
                              return ProfileButtonWidget(
                                heroIcon: HeroiconsOutline.bell, title: 'notification'.tr,
                            ...
                            isLoggedIn ? ProfileButtonWidget(heroIcon: HeroiconsOutline.lockClosed, title: 'change_password'.tr, onTap: () {
                              Get.toNamed(RouteHelper.getResetPasswordRoute(phone: '', email: '', token: '', page: 'password-change'));
                            }) : const SizedBox(),
                            SizedBox(height: isLoggedIn ? Dimensions.paddingSizeSmall : 0),

                            isLoggedIn ? ProfileButtonWidget(
                              heroIcon: HeroiconsOutline.trash,
