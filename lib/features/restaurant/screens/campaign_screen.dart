...
import 'package:mnjood/features/restaurant/screens/web_campaign_screen.dart';
...
class _CampaignScreenState extends State<CampaignScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Set basic data first for immediate header display
      Get.find<CampaignController>().setCampaignFromWidget(widget.campaign);
      // Then fetch full campaign data with restaurants from API
            ...
            SliverAppBar(
              ...
              leading: InkWell(
                ...
                child: Container(
                  ...
                  child: const Icon(HeroiconsOutline.chevronLeft, color: Colors.white, size: 20),
                ),
              ),
                    ...
                    return campaignController.campaign != null ? Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                scrollingRate < 0.8 ? (campaignController.campaign!.startTime != null && campaignController.campaign!.endTime != null) ? Row(children: [
                                  Icon(HeroiconsSolid.clock, size: 20, color: Theme.of(context).disabledColor),
                          ...
                          campaignController.campaign!.availableDateEnds != null ? Container(
