...
class RestaurantService implements RestaurantServiceInterface {
  ...
  @override
  Future<RestaurantModel?> getRestaurantList(int offset, String filterBy, int topRated, int discount, int veg, int nonVeg, {bool fromMap = false, DataSourceEnum? source, String? businessType}) async {
    return await restaurantRepositoryInterface.getList(offset: offset, filterBy: filterBy, topRated: topRated, discount: discount, veg: veg, nonVeg: nonVeg, fromMap: fromMap, source: source, businessType: businessType);
  }

  @override
  Future<List<Restaurant>?> getOrderAgainRestaurantList({DataSourceEnum? source, String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantList(isOrderAgain: true, source: source, businessType: businessType);
  }

  @override
  Future<List<Restaurant>?> getRecentlyViewedRestaurantList(String type, {DataSourceEnum? source, String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantList(type: type, isRecentlyViewed: true, source: source, businessType: businessType);
  }

  @override
  Future<List<Restaurant>?> getPopularRestaurantList(String type, {DataSourceEnum? source, String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantList(type: type, isPopular: true, source: source, businessType: businessType);
  }

  @override
  Future<List<Restaurant>?> getLatestRestaurantList(String type, {DataSourceEnum? source, String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantList(type: type, isLatest: true, source: source, businessType: businessType);
  }

  @override
  Future<List<Restaurant>?> getDiscountRestaurantList({required String businessType, required DataSourceEnum source}) async {
    return await restaurantRepositoryInterface.getDiscountRestaurantList(businessType: businessType, source: source);
  }

  @override
  Future<RecommendedProductModel?> getRestaurantRecommendedItemList(int? restaurantId, {String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantRecommendedItemList(restaurantId, businessType: businessType);
  }

  @override
  Future<Restaurant?> getRestaurantDetails(String restaurantID, String slug, String? languageCode, {String? businessType}) async {
    return await restaurantRepositoryInterface.get(restaurantID, slug: slug, languageCode: languageCode, businessType: businessType);
  }
  ...
  Future<ProductModel?> getRestaurantProductList(int? restaurantID, int offset, int? categoryID, String type, {String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantProductList(restaurantID, offset, categoryID, type, businessType: businessType);
  }
  ...
  Future<ProductModel?> getRestaurantSearchProductList(String searchText, String? storeID, int offset, String type, {String? businessType}) async {
    return await restaurantRepositoryInterface.getRestaurantSearchProductList(searchText, storeID, offset, type, businessType: businessType);
  }
  ...
  Future<List<VendorBannerModel>?> getVendorBanners(int vendorId) async {
    return await restaurantRepositoryInterface.getVendorBanners(vendorId);
  }

  @override
  Future<List<CategoryModel>?> getVendorCategories(int vendorId, String? businessType) async {
    return await restaurantRepositoryInterface.getVendorCategories(vendorId, businessType);
  }
