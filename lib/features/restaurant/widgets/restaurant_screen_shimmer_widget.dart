        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Icon(HeroiconsOutline.heart, size: 25, color: Theme.of(context).shadowColor),
              const SizedBox(width: Dimensions.paddingSizeSmall),
              Icon(HeroiconsOutline.share, size: 25, color: Theme.of(context).shadowColor),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              Column(children: [
                Icon(HeroiconsSolid.star, color: Theme.of(context).shadowColor),
              ...
              Column(children: [
                Icon(HeroiconsOutline.mapPin, color: Theme.of(context).shadowColor),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                ClipRRect(
                  borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                  child: Shimmer(
              ...
              Column(children: [
                Icon(HeroiconsOutline.clock, color: Theme.of(context).shadowColor),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                ClipRRect(
                  borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                  child: Shimmer(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    Icon(HeroiconsOutline.magnifyingGlass, size: 20, color: Get.isDarkMode ? Colors.white.withValues(alpha: 0.05) : Colors.grey[300]),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Expanded(
