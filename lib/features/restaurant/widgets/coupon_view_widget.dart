                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Row(children: [
                          ...
                          InkWell(
                            ...
                            child: Icon(HeroiconsOutline.clipboard, size: 16 - (scrollingRate * (isDesktop ? 2 : 16)), color: Theme.of(context).primaryColor),
                          ),
                        ]),
                        ...
                        Row(children: [
                          ...
                          PriceConverter.convertPriceWithSvg(
                            ...
                            textStyle: robotoMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeSmall))),
