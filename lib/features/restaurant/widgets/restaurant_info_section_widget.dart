...
import 'package:mnjood/features/restaurant/widgets/info_view_widget.dart';
    ...
    return SliverAppBar(
      ...
      leading: !isDesktop ? IconButton(
        icon: Container(
          ...
          child: Icon(HeroiconsOutline.chevronLeft, color: Theme.of(context).cardColor, size: 28),
        ),
        onPressed: () => Get.back(),
      ) : const SizedBox(),
              ...
              title: CustomizableSpaceBarWidget(
                builder: (context, scrollingRate) {
                  return !isDesktop ? Container(
                    ...
                    alignment: Alignment.bottomLeft,
                    child: Container(
                      height: (restaurant.announcementActive ?? false) ? 200 : 160,
                      decoration: BoxDecoration(
                        color: Theme.of(context).cardColor,
                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                      ...
                      child: Column(
                        children: [
                          (restaurant.announcementActive ?? false) && restaurant.announcementMessage != null ? Container(
