      ...
      ResponsiveHelper.isDesktop(context) ? Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            PriceConverter.convertPriceWithSvg(restaurant!.minimumOrder, textStyle: robotoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
            ),
          ]),
        ])),
        const SizedBox(width: Dimensions.paddingSizeSmall),
          ...
          return InkWell(
            ...
            child: ResponsiveHelper.isDesktop(context) ? Container(
              ...
              child: Center(
                child: Row(
                  children: [
                    Icon(isWished ? HeroiconsSolid.heart : HeroiconsOutline.heart, color: Colors.white, size: 14),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
      ...
      IntrinsicHeight(
        child: Row(children: [
          ...
          InkWell(
            ...
            child: Column(children: [
              // Icon(HeroiconsOutline.mapPin, color: Theme.of(context).primaryColor, size: 20),
          ...
          Column(children: [
            Row(children: [
              // Icon(HeroiconsOutline.clock, color: Theme.of(context).primaryColor, size: 20),
          ...
          (restaurant!.delivery! && restaurant!.freeDelivery!) ? Column(children: [
            Icon(HeroiconsOutline.banknotes, color: Theme.of(context).primaryColor, size: 20),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
