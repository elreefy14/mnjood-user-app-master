  ...
  Widget build(BuildContext context) {
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
      Row(children: [
        ...
        !isDesktop ? Container(
          ...
          child: ClipRRect(
            ...
            child: Stack(children: [
              ...
              restController.isRestaurantOpenNow(restaurant.active ?? false, restaurant.schedules) ? const SizedBox() : Positioned(
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Row(children: [
            ...
            PriceConverter.convertPriceWithSvg(
              restaurant.priceStartFrom,
              textStyle: robotoMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall - (scrollingRate * 2), color: Theme.of(context).primaryColor),
        ...
        Column(children: [
          ...
          AppConstants.webHostedUrl.isNotEmpty ? InkWell(
            ...
            child: Icon(
              HeroiconsOutline.share, size: 20  - (scrollingRate * 4),
            ),
          ) : const SizedBox(),
        ]),
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Column(children: [
          Icon(HeroiconsOutline.clock, color: Theme.of(context).primaryColor, size: 20 - (scrollingRate * (isDesktop ? 2 : 20))),
          // const SizedBox(height: 2),

          Text(restaurant.deliveryTime ?? '30-45 min', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeSmall)), color: Theme.of(context).textTheme.bodyLarge?.color)),
        ]),
        const Expanded(child: SizedBox()),
        ...
        InkWell(
          ...
          child: Column(children: [
            Row(children: [
              Icon(HeroiconsSolid.star, color: Theme.of(context).primaryColor, size: 20 - (scrollingRate * (isDesktop ? 2 : 20))),
              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
              Text(
        ...
        ((restaurant.delivery ?? false) && (restaurant.freeDelivery ?? false)) ? const Expanded(child: SizedBox()) : const SizedBox(),

        ((restaurant.delivery ?? false) && (restaurant.freeDelivery ?? false)) ? Column(children: [
          Icon(HeroiconsOutline.banknotes, color: Theme.of(context).primaryColor, size: 20 - (scrollingRate * (isDesktop ? 2 : 20))),
          const SizedBox(width: Dimensions.paddingSizeExtraSmall),
          Text(
            'free_delivery'.tr,
