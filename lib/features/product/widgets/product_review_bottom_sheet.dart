...
import 'package:mnjood/features/review/widgets/rating_widget.dart';
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Padding(
            ...
            child: InkWell(
              ...
              child: Icon(HeroiconsOutline.xMark, color: Theme.of(context).disabledColor.withValues(alpha: 0.6), size: 22),
            ),
          ),
        ]),
