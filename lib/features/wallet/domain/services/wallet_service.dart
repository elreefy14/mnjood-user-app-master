...
import 'package:mnjood/features/wallet/domain/services/wallet_service_interface.dart';
...
class WalletService implements WalletServiceInterface {
  ...
  Future<void> addFundToWallet(double amount, String paymentMethod) async{
    ...
    if (response.statusCode == 200) {
      // V3 API: {success:true, data: {redirect_link:...}} or V1: {redirect_link:...}
      var body = response.body;
      String? redirectUrl = body['redirect_link']
          ?? body['data']?['redirect_link']
