...
class _AddFundDialogueWidgetState extends State<AddFundDialogueWidget> {
  ...
  void initState() {
    ...
    if((Get.find<SplashController>().configModel?.activePaymentMethodList?.length ?? 0) == 1){
                ...
                Flexible(
                  child: SingleChildScrollView(
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      ListView.builder(
                        itemCount: Get.find<SplashController>().configModel?.activePaymentMethodList?.length ?? 0,
                        shrinkWrap: true,
