...
import 'package:mnjood/features/wallet/widgets/add_fund_dialogue_widget.dart';
        ...
        return Column(
          ...
          children: [
            Stack(children: [
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Row(children: [
                    PriceConverter.convertPriceWithSvg(
                      ...
                      textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).cardColor),
                      symbolColor: Theme.of(context).cardColor,
                      symbolSize: 20,
                    ),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                
                    (Get.find<SplashController>().configModel?.addFundStatus ?? false) ? JustTheTooltip(
                      ...
                      child: InkWell(
                        ...
                        child: Icon(HeroiconsOutline.informationCircle, color: Theme.of(context).cardColor),
                      ),
                    ) : const SizedBox(),
                  ]),
                ]),
              ...
              (Get.find<SplashController>().configModel?.addFundStatus ?? false) ? Positioned(
                ...
                child: InkWell(
                  onTap: (){
                    if(Get.find<SplashController>().configModel!.digitalPayment!
                        && (Get.find<SplashController>().configModel!.activePaymentMethodList?.isNotEmpty ?? false)) {
                      Get.dialog(
                        const Dialog(
