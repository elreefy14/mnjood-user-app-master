...
import 'package:mnjood/features/wallet/widgets/bonus_banner_widget.dart';
import 'package:mnjood/features/wallet/widgets/wallet_card_widget.dart';
import 'package:mnjood/features/wallet/widgets/wallet_history_widget.dart';
import 'package:mnjood/features/wallet/widgets/web_bonus_banner_view_widget.dart';
    ...
    if(Get.find<AuthController>().isLoggedIn()){
      ...
      scrollController.addListener(() {
        if (scrollController.position.pixels == scrollController.position.maxScrollExtent
          ...
          int pageSize = ((Get.find<WalletController>().popularPageSize ?? 0) / 10).ceil();
