...
import 'package:mnjood/features/auth/domain/models/restaurant_body_model.dart';
import 'package:mnjood/features/auth/domain/models/translation_body_model.dart';
import 'package:mnjood/features/auth/widgets/cuisine_widget.dart';
import 'package:mnjood/features/business/widgets/base_card_widget.dart';
import 'package:mnjood/features/business/widgets/package_card_widget.dart';
import 'package:mnjood/features/business/widgets/web_business_plan_widget.dart';
...
import 'package:mnjood/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:mnjood/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:mnjood/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:mnjood/features/auth/widgets/pass_view_widget.dart';
import 'package:mnjood/features/auth/widgets/registration_stepper_widget.dart';
import 'package:mnjood/features/auth/widgets/restaurant_additional_data_section_widget.dart';
import 'package:mnjood/features/auth/widgets/select_location_view_widget.dart';
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: restaurantRegController.pickedLogo != null ? GetPlatform.isWeb ? Image.network(
                                                    ...
                                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                      ...
                                                      Icon(HeroiconsSolid.camera, size: 38, color: Theme.of(context).disabledColor.withValues(alpha: 0.6)),
                                                      const SizedBox(height: Dimensions.paddingSizeSmall),
                                                    ...
                                                    child: Center(
                                                      child: Visibility(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: const Icon(HeroiconsSolid.camera, color: Colors.white),
                                                        ),
                                                      ),
                                                    ),
                                                  ),
                                                    ...
                                                    child: Center(
                                                      child: Visibility(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: const Icon(HeroiconsSolid.camera, color: Colors.white, size: 50),
                                                        ),
                                                      ),
                                                    ),
                                                  ),
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Row(children: [
                                              ...
                                              Icon(HeroiconsOutline.calendarDays, color: Theme.of(context).primaryColor),
                                            ]),
                                          ),
                                                          ...
                                                          Builder(
                                                            builder: (context) {
                                                              ...
                                                              if (fileName.endsWith('.pdf')) {
                                                                ...
                                                                return Row(
                                                                  children: [
                                                                    const Icon(HeroiconsOutline.documentText, size: 40, color: Colors.red),
                                                                ...
                                                                return Row(
                                                                  children: [
                                                                    Icon(HeroiconsOutline.documentText, size: 40, color: Theme.of(context).primaryColor),
                                                                    const SizedBox(width: 10),
                                                                    Expanded(
                                                                      child: Text(
                                                                        fileName,
                                ...
                                Container(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    CustomTextFieldWidget(
                                      ...
                                      inputType: TextInputType.name,
                                      capitalization: TextCapitalization.words,
                                      prefixIcon: HeroiconsSolid.userCircle,
                                      iconSize: 25,
                                      required: true,
            ...
            children: [
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Row(children: [
                    const Icon(HeroiconsOutline.user),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                      ...
                      Expanded(flex: 4, child:  Align(alignment: Alignment.center, child: Stack(children: [
                        ClipRRect(
                          ...
                          child: restaurantRegistrationController.pickedLogo != null ? GetPlatform.isWeb ? Image.network(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                              Icon(HeroiconsSolid.camera, color: Theme.of(context).disabledColor.withValues(alpha: 0.8), size: 38),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                              ...
                              child: Center(
                                child: Visibility(
                                  ...
                                  child: Container(
                                    ...
                                    child: const Icon(HeroiconsOutline.camera, color: Colors.white, size: 50),
                                  ),
                                ),
                              ),
                            ),
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Row(children: [
                    const Icon(HeroiconsOutline.buildingOffice),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Row(children: [
                    const Icon(HeroiconsOutline.lockClosed),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
