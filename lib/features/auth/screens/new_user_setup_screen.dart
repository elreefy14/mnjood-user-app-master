  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isDesktop(context) ? null : AppBar(leading: IconButton(
        onPressed: () => Get.back(),
        icon: Icon(HeroiconsOutline.chevronLeft, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            child: Form(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                _isSocial ? CustomTextFieldWidget(
                  ...
                  countryDialCode: Get.find<LocalizationController>().locale.countryCode,
                ...
                (Get.find<SplashController>().configModel?.refEarningStatus ?? false) ? CustomTextFieldWidget(
