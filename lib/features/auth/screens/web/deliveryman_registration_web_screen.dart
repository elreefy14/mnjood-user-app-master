...
import 'package:mnjood/common/widgets/web_screen_title_widget.dart';
                                ...
                                ClipRRect(
                                  ...
                                  child: widget.deliverymanController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                                    ...
                                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                      ...
                                      Icon(HeroiconsSolid.camera, size: 38, color: Theme.of(context).disabledColor.withValues(alpha: 0.7)),
                                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                    ...
                                    Positioned(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                                          child: const Icon(HeroiconsOutline.trash, color: Colors.red, size: 20),
                                        ),
                                      ),
                                    ),
                                  ]),
