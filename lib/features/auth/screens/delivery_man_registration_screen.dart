...
import 'package:mnjood/features/auth/domain/models/delivery_man_body_model.dart';
...
import 'package:mnjood/features/auth/screens/web/deliveryman_registration_web_screen.dart';
import 'package:mnjood/features/auth/widgets/deliveryman_additional_data_section_widget.dart';
import 'package:mnjood/features/auth/widgets/pass_view_widget.dart';
import 'package:mnjood/helper/custom_validator.dart';
import 'package:mnjood/helper/extensions.dart';
                                    ...
                                    ClipRRect(
                                      ...
                                      child: deliverymanController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                                        ...
                                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                          ...
                                          Icon(HeroiconsSolid.camera, size: 40, color: Theme.of(context).disabledColor.withValues(alpha: 0.7)),
                                          const SizedBox(height: Dimensions.paddingSizeSmall),
                                    ...
                                    deliverymanController.pickedImage != null ? Positioned(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child:  Icon(HeroiconsOutline.minus, size: 18, color: Theme.of(context).cardColor,),
                                        ),
                                      ),
                              ...
                              Container(
                                ...
                                child: Column(children: [
                                  ...
                                  CustomTextFieldWidget(
                                    ...
                                    prefixIcon: HeroiconsSolid.envelope,
                                    labelText: 'email'.tr,
                                    required: true,
                                      ...
                                      return InkWell(
                                        ...
                                        child: DottedBorder(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                              Icon(HeroiconsSolid.camera, color: Theme.of(context).disabledColor.withValues(alpha: 0.8), size: 40),
                                          ...
                                          Positioned(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: const Icon(HeroiconsOutline.trash, color: Colors.red),
                                              ),
                                            ),
                                          ),
                                        ]),
