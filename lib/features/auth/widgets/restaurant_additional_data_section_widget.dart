            ...
            child: showTextField ? CustomTextFieldWidget(
              ...
              child: Row(children: [
                ...
                InkWell(
                  ...
                  child: Icon(HeroiconsOutline.calendarDays, size: 22),
                ),
              ]),
                  ...
                  return restaurantRegiController.dataList![index].mediaData!.uploadMultipleFiles == 0 && file != null ? Stack(children: [
                    ...
                    Positioned(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(HeroiconsOutline.xMark, color: Theme.of(context).disabledColor, size: 20),
                      ),
                    ),
                    ...
                    child: DottedBorder(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          child: Row(children: [
                            Icon(HeroiconsOutline.cloudArrowUp, size: 35, color: Theme.of(context).disabledColor),
                            const SizedBox(width: Dimensions.paddingSizeSmall),
