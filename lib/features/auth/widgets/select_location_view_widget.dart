...
import 'package:mnjood/features/auth/widgets/zone_selection_widget.dart';
...
import 'package:mnjood/features/location/widgets/location_search_dialog.dart';
          ...
          widget.fromView ? Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Icon(HeroiconsOutline.arrowsPointingOut, color: Theme.of(context).primaryColor, size: 20),
              ),
            ),
          ) : const SizedBox(),
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                margin: const EdgeInsets.only(right: Dimensions.paddingSizeDefault),
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(50), color: Colors.white),
                child: Icon(HeroiconsOutline.mapPin, color: Theme.of(context).primaryColor, size: widget.fromView ? 20 : 25),
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                InkWell(
                  ...
                  child: const Icon(HeroiconsOutline.plus, size: 25),
                ),
                const Divider(),
                ...
                InkWell(
                  ...
                  child: const Icon(HeroiconsOutline.minus, size: 25),
                ),
              ]),
            ),
          ) : const SizedBox(),
