...
import 'package:mnjood/features/language/widgets/language_bottom_sheet_widget.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          isLoggedIn ? SettingsButton(icon: HeroiconsOutline.lockClosed, title: 'change_password'.tr, onTap: () {
            Get.toNamed(RouteHelper.getResetPasswordRoute(phone: '', email: '', token: '', page: 'password-change'));
          }) : const SizedBox(),
          SizedBox(height: isLoggedIn ? Dimensions.paddingSizeSmall : 0),

          SettingsButton(
            icon: HeroiconsOutline.language, title: 'language'.tr,
            onTap: () {
