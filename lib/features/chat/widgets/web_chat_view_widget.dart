...
import 'package:mnjood/common/widgets/web_search_field_widget.dart';
...
import 'package:mnjood/features/chat/widgets/chatting_shimmer_widget.dart';
import 'package:mnjood/features/chat/widgets/message_bubble_widget.dart';
import 'package:mnjood/features/chat/widgets/web_conversation_list_view_widget.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        (Get.find<AuthController>().isLoggedIn() && widget.conversation != null) ? Center(child: SizedBox(width: Dimensions.webMaxWidth, child: WebSearchFieldWidget(
                          ...
                          hint: 'search_'.tr,
                          suffixIcon: widget.chatController.searchConversationModel != null ? HeroiconsOutline.xMark : HeroiconsOutline.magnifyingGlass,
                        ...
                        Expanded(
                          child: Column(
                            children: [
                              ...
                              /// Delivery Man conversations only
                              Expanded(
                                child: WebConversationListViewWidget(
                              ...
                              itemBuilder: (context, index) {
                                return MessageBubbleWidget(
                                  ...
                                  userType: widget.chatController.notificationBody!.adminId != null ? UserType.admin
                                      : widget.chatController.notificationBody!.deliverymanId != null ? UserType.delivery_man : UserType.delivery_man,
                                );
                              },
                            ),
                          ),
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: const Padding(
                                                              ...
                                                              child: Icon(HeroiconsOutline.xMark, color: Colors.red, size: 15),
                                                            ),
                                                          ),
                                                        ),
                                                      )],
