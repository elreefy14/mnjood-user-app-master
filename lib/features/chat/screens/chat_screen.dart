...
import 'package:mnjood/features/chat/widgets/conversion_details_shimmer.dart';
...
import 'package:mnjood/features/chat/widgets/message_bubble_widget.dart';
        ...
        child: Scaffold(
          ...
          appBar: !isDesktop ? AppBar(
            ...
            title: Row(children: [
              ...
              ClipOval(child: chatController.messageModel?.conversation?.receiver?.imageFullUrl != null
                ? CustomImageWidget(
                    image: chatController.messageModel!.conversation!.receiver!.imageFullUrl!,
                    fit: BoxFit.cover, height: 35, width: 35,
                  )
                : CustomAssetImageWidget(Images.logo, height: 35, width: 35, fit: BoxFit.cover),
              ),
                                ...
                                itemBuilder: (context, index) {
                                  return MessageBubbleWidget(
                                    ...
                                    userType: widget.notificationBody!.adminId != null ? UserType.admin
                                        : widget.notificationBody!.deliverymanId != null ? UserType.delivery_man : UserType.delivery_man,
                                  );
                                },
                              ),
                            ),
                                ...
                                return Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
                                      ...
                                      Icon(HeroiconsOutline.videoCamera, size: 35, color: Theme.of(context).disabledColor),
                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
