            ...
            _chewController = ChewieController(
              ...
              errorBuilder: (context, error) =>  Center(child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(HeroiconsOutline.exclamationCircle, color: Theme.of(context).hintColor, size: 40),
        ...
        child: Stack(
          children: [
            ...
            Positioned(top: 10, right: 0, child: IconButton(
              ...
              icon: const Icon(HeroiconsOutline.xMark, color: Colors.white),
            )),
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: CustomInkWellWidget(
                    ...
                    child: Icon(HeroiconsOutline.arrowLeft, color: isDesktop ? Colors.white : Colors.black),
                  ),
                ),
              ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: CustomInkWellWidget(
                    ...
                    radius: 50,
                    padding: EdgeInsets.all(Dimensions.paddingSizeSmall),
                    child: Icon(HeroiconsOutline.arrowRight, color: isDesktop ? Colors.white : Colors.black),
                  ),
                ),
              ),
