            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                JustTheTooltip(
                  ...
                  child: DottedBorder(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Icon(HeroiconsOutline.clipboard, color: unavailable ? Theme.of(context).primaryColor.withValues(alpha: 0.5) : Theme.of(context).primaryColor, size: 20),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  PriceConverter.convertPriceWithSvg(couponList![index].minPurchase, textStyle: robotoMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
