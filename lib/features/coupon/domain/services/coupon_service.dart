...
class CouponService implements CouponServiceInterface{
  ...
  @override
  Future<List<CouponModel>?> getRestaurantCouponList({required int restaurantId, String? vendorType}) async {
    return await couponRepositoryInterface.getRestaurantCouponList(restaurantId, vendorType: vendorType);
  }
