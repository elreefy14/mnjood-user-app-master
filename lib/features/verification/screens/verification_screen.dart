...
import 'package:mnjood/features/verification/controllers/verification_controller.dart';
import 'package:mnjood/features/verification/domein/model/verification_data_model.dart';
        ...
        child: Center(child: Container(
          ...
          child: GetBuilder<VerificationController>(builder: (verificationController) {
            return Column(children: [
              ...
              (Get.find<SplashController>().configModel?.demo ?? false) ? Text(
                  ...
                  builder: (profileController) {
                    return Padding(
                      ...
                      child: CustomButtonWidget(
                        ...
                        isLoading: verificationController.isLoading || profileController.isLoading || authController.isLoading,
                        onPressed: verificationController.verificationCode.length < 6 ? null : () {
                          if(widget.firebaseSession != null && widget.userModel == null) {
                            ...
                            Get.find<AuthController>().verifyOtp(
                              phone: _number!, otp: verificationController.verificationCode,
                            ).then((value) {
                              if(value.isSuccess) {
                                _handleVerifyResponse(value, _number, _email);
                              } else {
