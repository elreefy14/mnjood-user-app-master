...
class CoffeeCategoriesScreen extends StatefulWidget {
  const CoffeeCategoriesScreen({super.key});

  @override
  State<CoffeeCategoriesScreen> createState() => _CoffeeCategoriesScreenState();
}

class _CoffeeCategoriesScreenState extends State<CoffeeCategoriesScreen> {
  final ScrollController scrollController = ScrollController();
  final TextEditingController _searchController = TextEditingController();
  static const String _businessType = 'coffee_shop';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarWidget(title: 'coffee_categories'.tr),
