...
import 'package:mnjood/features/business/domain/models/package_model.dart';
import 'package:mnjood/features/business/widgets/curve_clipper_widget.dart';
import 'package:mnjood/features/business/widgets/package_widget.dart';
      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: Column(children: [
            ...
            PriceConverter.convertPriceWithSvg(packages.price, textStyle: robotoBold.copyWith(fontSize: 35, color: canSelect ? Theme.of(context).cardColor : const Color(0xff334257)),
            ),
