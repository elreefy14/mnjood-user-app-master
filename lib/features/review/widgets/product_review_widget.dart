...
import 'package:mnjood/common/widgets/my_text_field_widget.dart';
                  ...
                  children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        PriceConverter.convertPriceWithSvg(widget.orderDetailsList[index].foodDetails!.price, textStyle: robotoBold),
                      ],
                    )),
                    Row(children: [
                      Text(
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      return InkWell(
                        child: Icon(
                          reviewController.ratingList[index] < (i + 1) ? HeroiconsOutline.star : HeroiconsSolid.star,
                          size: 25,
