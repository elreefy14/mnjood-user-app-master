                      ...
                      child: Container(
                        ...
                        child: widget.isDeliveryLog ? Column(children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            PriceConverter.convertPriceWithSvg(widget.totalAmount! * widget.orderQuantity!, textStyle: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: logData.orderStatus == 'pending' ? Theme.of(context).primaryColor.withValues(alpha: 0.1) : logData.orderStatus == 'delivered' ? Colors.green.withValues(alpha: 0.1)
                              ...
                              child: Text(
                                ...
                                style: robotoRegular.copyWith(
                                  color: logData.orderStatus == 'pending' ? Theme.of(context).primaryColor : logData.orderStatus == 'delivered' ? Colors.green : Theme.of(context).primaryColor,
