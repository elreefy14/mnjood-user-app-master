            ...
            Align(
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Icon(HeroiconsOutline.xCircle, size: 25, color: Theme.of(context).disabledColor),
                ),
              ),
            ),
                      ...
                      itemBuilder: (context, index){
                        return Container(
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              children: [
                                Icon(orderController.orderCancelReasons![index].reason == orderController.cancelReason ? HeroiconsSolid.checkCircle : HeroiconsOutline.minusCircle, color: Theme.of(context).primaryColor, size: 18),
