...
import 'package:mnjood/features/order/widgets/guest_custom_stepper.dart';
import 'package:mnjood/features/order/widgets/traking_map_widget.dart';
                        ...
                        Column(children: [
                          ...
                          GuestCustomStepper(
                            ...
                            trailing: (orderController.trackModel?.deliveryMan?.phone != null && status != OrderStatus.delivered.name && status != OrderStatus.refund_requested.name) ? InkWell(
                              ...
                              child: const Icon(HeroiconsOutline.phone),
                            ) : const SizedBox(),
                          ),
