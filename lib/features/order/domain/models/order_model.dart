...
class PaginatedOrderModel {
  ...
  PaginatedOrderModel.fromJson(Map<String, dynamic> json) {
    totalSize = _safeInt(json['total_size']);
...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    orderAmount = _safeDouble(json['order_amount']);
    couponDiscountAmount = _safeDouble(json['coupon_discount_amount']);
    couponDiscountTitle = json['coupon_discount_title'];
    paymentStatus = json['payment_status'];
    orderStatus = json['order_status'];
    totalTaxAmount = _safeDouble(json['total_tax_amount']);
    ...
    deliveryCharge = _safeDouble(json['delivery_charge']);
    ...
    scheduled = _safeInt(json['scheduled']);
    dmTips = _safeDouble(json['dm_tips']);
    restaurantDiscountAmount = _safeDouble(json['restaurant_discount_amount']);
    failed = json['failed'];
    detailsCount = _safeInt(json['details_count']);
    processingTime = _safeInt(json['processing_time']);
    deliveryMan = json['delivery_man'] != null && json['delivery_man'] is Map<String, dynamic>
        ? DeliveryMan.fromJson(json['delivery_man'])
        : null;
    // V3 API uses 'vendor', legacy uses 'restaurant'
    // Make sure it's a Map before trying to parse (could be int like restaurant_id)
    var restaurantData = json['restaurant'] ?? json['vendor'];
    restaurant = (restaurantData != null && restaurantData is Map<String, dynamic>)
        ? Restaurant.fromJson(restaurantData)
        : null;
    // V3 API may return delivery_address as JSON string or Map
    if (json['delivery_address'] != null) {
      var addressData = json['delivery_address'];
      ...
      deliveryAddress = addressData is Map<String, dynamic> ? AddressModel.fromJson(addressData) : null;
    }
    ...
    subscriptionId = _safeInt(json['subscription_id']);
    ...
    additionalCharge = _safeDouble(json['additional_charge']) ?? 0;
    if (json['partially_paid_amount'] != null) {
      partiallyPaidAmount = _safeDouble(json['partially_paid_amount']);
    }
    ...
    extraPackagingAmount = _safeDouble(json['extra_packaging_amount']);
    referrerBonusAmount = _safeDouble(json['ref_bonus_amount']);
    orderReference = json['order_reference'] != null ? OrderReference.fromJson(json['order_reference']) : null;
    bringChangeAmount = _safeDouble(json['bring_change_amount']);
    itemCampaignId = _safeInt(json['item_campaign_id']);
    chatCount = _safeInt(json['chat_count']);
...
class DeliveryMan {
  ...
  DeliveryMan.fromJson(Map<String, dynamic> json) {
    ...
    zoneId = _safeInt(json['zone_id']);
    active = _safeInt(json['active']);
    available = _safeInt(json['available']);
    avgRating = _safeDouble(json['avg_rating']) ?? 0.0;
    ratingCount = _safeInt(json['rating_count']);
    lat = json['lat']?.toString();
    lng = json['lng']?.toString();
    location = json['location'];
    restaurantId = _safeInt(json['restaurant_id']);
  }
...
class SubscriptionModel {
  ...
  SubscriptionModel.fromJson(Map<String, dynamic> json) {
    ...
    userId = _safeInt(json['user_id']);
    restaurantId = _safeInt(json['restaurant_id']);
    billingAmount = _safeDouble(json['billing_amount']) ?? 0.0;
    paidAmount = _safeDouble(json['paid_amount']) ?? 0.0;
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    isPausedToday = json['is_paused_today'];
    // Try 'restaurant' first, then 'store' for V3 API compatibility
    var restaurantData = json['restaurant'] ?? json['store'];
    restaurant = restaurantData != null ? Restaurant.fromJson(restaurantData) : null;
  }
