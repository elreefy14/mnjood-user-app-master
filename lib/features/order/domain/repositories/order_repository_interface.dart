...
abstract class OrderRepositoryInterface extends RepositoryInterface {
  ...
  Future<ResponseModel> cancelOrder(String orderID, String? reason, {int? reasonId, String? customReason});
  ...
  Future<List<SubstitutionProposal>?> getSubstitutionProposals(int orderId);
  Future<ResponseModel> respondToSubstitution(int proposalId, String action);
}