...
import 'package:mnjood/features/location/widgets/animated_map_icon_extended.dart';
import 'package:mnjood/features/location/widgets/animated_map_icon_minimized.dart';
import 'package:mnjood/features/location/widgets/custom_floating_action_button.dart';
                  ...
                  Positioned(
                    ...
                    child: Column(children: [
                      ...
                      CustomFloatingActionButton(
                        ...
                        icon: HeroiconsOutline.arrowsPointingOut,
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          CustomFloatingActionButton(
                            icon: HeroiconsOutline.plus, heroTag: 'add_button',
                            iconColor: Theme.of(context).disabledColor, iconSize: 20,
                            onTap: () {
                              _currentZoomLevel++;
                          ...
                          CustomFloatingActionButton(
                            icon: HeroiconsOutline.minus, heroTag: 'remove_button',
                            iconColor: Theme.of(context).disabledColor, iconSize: 20,
                            onTap: () {
                              _currentZoomLevel--;
                              locationController.mapController?.animateCamera(CameraUpdate.zoomTo(_currentZoomLevel));
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        ...
                        Text(
                          index == 0 ? 'home_address'.tr : index == 1 ? 'office'.tr : 'others'.tr,
