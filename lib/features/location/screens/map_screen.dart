...
class MapScreenState extends State<MapScreen> {
                    ...
                    child: Container(
                      ...
                      child: widget.fromRestaurant ? Row(children: [
                        ...
                        InkWell(
                          ...
                          child: const Icon(HeroiconsOutline.arrowUturnRight),
                        ),
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            Icon(
                              widget.address.addressType == 'home' ? HeroiconsOutline.home : widget.address.addressType == 'office'
                                  ? HeroiconsOutline.briefcase : HeroiconsOutline.mapPin,
  ...
  void _setMarker({AddressModel? address, bool fromCurrentLocation = false}) async {
    BitmapDescriptor destinationImageData = await MarkerHelper.createHeroiconMarker(
      icon: widget.fromRestaurant || widget.fromOrder ? HeroiconsSolid.buildingStorefront : HeroiconsSolid.mapPin,
