    ...
    return LocationSearchDialog(mapController: mapController, child: Container(
      ...
      child: Row(children: [
        (pickedAddress != null && pickedAddress!.isNotEmpty) ? Icon(
          HeroiconsOutline.mapPin, size: 25,
        ...
        Icon(HeroiconsOutline.magnifyingGlass, size: 25, color: fromDialog! ? Theme.of(context).disabledColor.withValues(alpha: 0.5) : Theme.of(context).textTheme.bodyLarge!.color),
      ]),
    ));
  }
}
