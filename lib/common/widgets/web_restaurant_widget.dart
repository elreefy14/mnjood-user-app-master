      ...
      child: InkWell(
        onTap: (){
          if(restaurant != null && restaurant!.restaurantStatus == 1){
            RouteHelper.navigateToStoreOrShowClosedDialog(restaurant!, context);
          }else if(restaurant != null && restaurant!.restaurantStatus == 0){
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Stack(children: [
                ...
                DiscountTagWidget(
                  ...
                  discountType: 'percent', freeDelivery: restaurant?.freeDelivery ?? false,
                ),
                (restaurant != null && Get.find<RestaurantController>().isOpenNow(restaurant!)) ? const SizedBox() : const NotAvailableWidget(isRestaurant: true),
                Positioned(
                  ...
                  child: GetBuilder<FavouriteController>(builder: (wishController) {
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          isWished ? HeroiconsSolid.heart : HeroiconsOutline.heart,  size: 20,
