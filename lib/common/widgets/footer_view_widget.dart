                  ...
                  builder: (splashController) {
                    return Padding(
                      ...
                      child: SizedBox(height: 50, child: ListView.builder(
                        ...
                        itemCount: splashController.configModel?.socialMedia?.length ?? 0,
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            FooterButton(title: 'categories'.tr, route: RouteHelper.getCategoryRoute(businessType: 'restaurant')),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            _config!.refundPolicyStatus! ? FooterButton(title: 'refund_policy'.tr, route: RouteHelper.getHtmlRoute('refund-policy')) : const SizedBox(),
                            SizedBox(height: _config.refundPolicyStatus! ? Dimensions.paddingSizeSmall : 0.0),

                            _config.shippingPolicyStatus! ? FooterButton(title: 'shipping_policy'.tr, route: RouteHelper.getHtmlRoute('shipping-policy')) : const SizedBox(),
