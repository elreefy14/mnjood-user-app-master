              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Row(children: [
                      Icon(HeroiconsSolid.star, size: 16, color: Theme.of(context).shadowColor),
                ...
                Column(mainAxisAlignment: isRestaurant ? MainAxisAlignment.start : MainAxisAlignment.spaceBetween, children: [
                  Padding(
                    ...
                    child: Icon(
                      HeroiconsOutline.heart,  size: desktop ? 30 : 25,
                      color: Theme.of(context).shadowColor,
                    ),
                  ),
                  ...
                  !isRestaurant ? Padding(
                    padding: EdgeInsets.symmetric(vertical: desktop ? Dimensions.paddingSizeSmall : 0),
                    child: Icon(HeroiconsOutline.plus, size: desktop ? 30 : 25, color: Theme.of(context).shadowColor),
                  ) : const SizedBox(),
                ]),
