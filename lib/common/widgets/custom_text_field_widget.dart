...
import 'package:mnjood/common/widgets/code_picker_widget.dart';
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              label: widget.showLabelText ? Text.rich(TextSpan(children: [
                TextSpan(
                  ...
                  style: robotoRegular.copyWith(
                    ...
                    color: ((widget.focusNode?.hasFocus == true || (widget.controller?.text.isNotEmpty ?? false) ) &&  widget.isEnabled) ? Theme.of(context).textTheme.bodyLarge?.color :  Theme.of(context).hintColor.withValues(alpha: .75),
                  ),
                ),
              ...
              suffixIcon: widget.isPassword ? IconButton(
                icon: Icon(_obscureText ? HeroiconsOutline.eyeSlash : HeroiconsOutline.eye, color: Theme.of(context).hintColor.withValues(alpha: 0.3)),
                onPressed: _toggle,
